/*--------------This Script Contains DateCalendar Validation only ------------------------ */




/*--------------DateCalendar Validation ------------------------ */
...
Calendar.prototype.show = function() {
	...
	this.wwrite("<TABLE WIDTH='100%' BORDER=1 ALIGN = CENTER><TR HEIGHT=25><TD ALIGN=center BGCOLOR='#e0e0e0' WIDTH=20>");
	this.wwrite("<A HREF=\"" +
		"javascript:window.opener.Build(" + 
		"'" + this.gReturnItem + "', '" + this.gMonth + "', '" + (parseInt(this.gYear)-1) + "', '" + this.gFormat + "'" +
		");" +
		"\"><<<\/A></TD><TD ALIGN=center BGCOLOR='#e0e0e0' WIDTH=20>");
	this.wwrite("<A HREF=\"" +
		"javascript:window.opener.Build(" + 
	...
	this.wwriteA("</B><BR>");
	this.wwriteA("</TD><TD ALIGN=center BGCOLOR='#e0e0e0' WIDTH=20>");
	this.wwrite("<A HREF=\"" +
		"javascript:window.opener.Build(" + 
...
Calendar.prototype.cal_header = function() {
	...
	vCode = vCode + "<TR HEIGHT=30>";
	vCode = vCode + "<TD WIDTH='14%' ALIGN = CENTER><FONT SIZE='2' FACE='" + fontface + "' COLOR='" + this.gHeaderColor + "'><B>Sun</B></FONT></TD>";
	...
	vCode = vCode + "<TD WIDTH='14%' ALIGN = CENTER><FONT SIZE='2' FACE='" + fontface + "' COLOR='" + this.gHeaderColor + "'><B>Sat</B></FONT></TD>";
	vCode = vCode + "</TR>";
...
Calendar.prototype.cal_data = function() {
	...
	*/
	...
	vCode = vCode + "<TR ALIGN = CENTER HEIGHT=25>";
...
function show_calendar() {
	...
	*/
	...
	vWinCal = window.open("", "Calendar", 
		"width=300,height=280,status=no,resizable=no,top=200,left=200");
