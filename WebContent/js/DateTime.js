...
function validateDateTimeFloat(varDate1,varTime1,varDate2,varTime2)
{
       var cmp=compareDates(varDate1,varDate2);
	   if (cmp == "larger")
			return false;
	   ...
	   if(cmp == "equal")
		    if(parseFloat(varTime1) > parseFloat(varTime2))
			  return false;
	
		  return true;		
}

function validateFinanceDateTimeFloat(varDate1,varTime1,varDate2,varTime2)
{
       var cmp=compareDates(varDate1,varDate2);
	   if (cmp == "larger")
			return false;
	   ...
	   if(cmp == "equal")
		    if(parseFloat(varTime1) > parseFloat(varTime2))
			  return false;
			else if(parseFloat(varTime1) == parseFloat(varTime2))
				return false;
