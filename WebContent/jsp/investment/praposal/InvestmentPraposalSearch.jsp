  ...
  function selectCheckboxes(optiontype) { 
	   ...
	   if(optiontype!='Add'){
		...
		if(optiontype=='Add'){		 
			 ...
			 window.location.href='searchProposal.do?method=showProposalAdd';
		 }
		if(optiontype=='Delete'){		 
			...
			if(state){
				if(val[1]=='A'){
				    ...
				    var url = "searchProposal.do?method=deleteProposal&deleteall="+recordcd;
				...
				return;
		 		...
		 		if(val[1]=='A'){
				    ...
				    var url = "searchProposal.do?method=showEditProposal&refNo="+recordcd;
					document.forms[0].action=url;
					document.forms[0].submit();
				}			 
		 }
		 ...
		 {	
		 	if(val[2]=='A'){
		 		...
		 		var url="searchProposal.do?method=approvalProposal&refNo="+recordcd+"&&edit=Y&updatedFlag=1";
			 	document.forms[0].action=url;
			 	document.forms[0].submit();
		 	}else{	    
			 	var url="searchProposal.do?method=approvalProposal&refNo="+recordcd+"&updatedFlag=1";
			 	document.forms[0].action=url;
			 	document.forms[0].submit();
		 	}
		 }
		 ...
		 {	
		 	if(val[1]!='A'){
		 		...
		 		var url="searchProposal.do?method=approvalProposal&refNo="+recordcd+"&&edit=Y&updatedFlag=2";
			 	document.forms[0].action=url;
			 	document.forms[0].submit();
		 	}else{	    
			 	var url="searchProposal.do?method=approvalProposal&refNo="+recordcd+"&updatedFlag=2";
			 	document.forms[0].action=url;
			 	document.forms[0].submit();
		 	}
		 }
		 ...
		 {		    
		 	if(val[2]!='A'){
		 		...
		 		var url="searchProposal.do?method=approvalProposal&refNo="+recordcd+"&&edit=Y&updatedFlag=3";
			 	document.forms[0].action=url;
			 	document.forms[0].submit();
		 	}else{	    
			 	var url="searchProposal.do?method=approvalProposal&refNo="+recordcd+"&updatedFlag=3";
			 	document.forms[0].action=url;
			 	document.forms[0].submit();
		 	}
		 }
		 ...
		 {		    
		 	if(val[3]!='A'){
		 		...
		 		var url="searchProposal.do?method=approvalProposal&refNo="+recordcd+"&&edit=Y&updatedFlag=4";
			 	document.forms[0].action=url;
			 	document.forms[0].submit();
		 	}else{	    
			 	var url="searchProposal.do?method=approvalProposal&refNo="+recordcd+"&updatedFlag=4";
			 	document.forms[0].action=url;
			 	document.forms[0].submit();
		 	}
		 }
		 ...
		 {		    
		 	if(val[4]!='A'){
		 			...
		 			var url="searchProposal.do?method=approvalProposal&refNo="+recordcd+"&&edit=Y&updatedFlag=5";
				 	document.forms[0].action=url;
				 	document.forms[0].submit();
		 	}else{	    
			 	var url="searchProposal.do?method=approvalProposal&refNo="+recordcd+"&updatedFlag=5";
			 	document.forms[0].action=url;
			 	document.forms[0].submit();
		 	}
		 }
		 ...
		 {		    
		 	if(val[4]!='A'){
		 			...
		 			var url="searchProposal.do?method=approvalProposal&refNo="+recordcd+"&&edit=Y&updatedFlag=6";
				 	document.forms[0].action=url;
				 	document.forms[0].submit();
		 	}else{	    
			 	var url="searchProposal.do?method=approvalProposal&refNo="+recordcd+"&updatedFlag=6";
			 	document.forms[0].action=url;
			 	document.forms[0].submit();
		 	}
		 }
		 ...
		 {		    
		 	if(val[6]!='A'){
		 			alert("As Level-6 approval is not Completed, Level-7 Approval cannot be made");
		 			return false;
		 	}else if(val[7]=='A'){
		 			var url="searchProposal.do?method=approvalProposal&refNo="+recordcd+"&&edit=Y&updatedFlag=7";
				 	document.forms[0].action=url;
				 	document.forms[0].submit();
		 	}else{	    
			 	var url="searchProposal.do?method=approvalProposal&refNo="+recordcd+"&updatedFlag=7";
			 	document.forms[0].action=url;
			 	document.forms[0].submit();
		 	}
		 }
	...
	<body onload="document.forms[0].refNo.focus();">
		<html:form action="/searchProposal.do?method=searchInvestProposal" onsubmit="return validate();">
				...
				<logic:present name="proposalList">
					<tr>
						<td align="left" valign="top">
							...
							<display:table cellpadding="0" cellspacing="0" class="GridBorder" keepStatus="false" style="width:810px;height:50px" export="true" sort="list" id="proposalTable" name="requestScope.proposalList"
								requestURI="/searchProposal.do?method=searchInvestProposal" pagesize="5">
