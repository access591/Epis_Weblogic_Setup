...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="document.forms[0].trustType.focus();" >
		<html:form action="/addTrustType.do?method=addTrustType" onsubmit="return validate();">
	...
	<table width="550" border=0 align="center" >
			...
			<tr>
				...
				<td  width="20%" class="tableTextBold" align=right nowrap>
					...
					<html:text size="12" property="description" styleClass="TextField" style="width:180 px" tabindex="2" maxlength="100" />
				</td>			
			</tr>
			<tr>
				<td colspan=4 align=center>&nbsp;
