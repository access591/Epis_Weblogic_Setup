...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="document.forms[0].approveDate.focus();">
		<html:form action="/approvalProposal.do?method=approvalUpdate&mode=rbiauction" onsubmit="return validate();">
...
<logic:iterate id="approval" name="proposal" property="approvals"> 
	...
	<logic:notEqual value="0" name="approval" property="key">
		<logic:notEqual value="7" name="approval" property="key">
		<bean:define id="invBean" name="approval" property="value" type="com.epis.bean.investment.InvestProposalAppBean" />
	...
	<logic:notEqual value="Y" name="edit" >
	<logic:equal value="7" name="approval" property="key">
...
<html:hidden property="refNo" name="proposal"/>
...
<html:hidden property="edit" value="<%=edit%>" />
				<tr>
					<td colspan=4 align=center>
						...
						<html:button styleClass="butt" property="Cancel" value="Cancel" onclick="javascript:window.location.href='searchProposal.do?method=searchInvestProposal&mode=rbiauction'" onblur="document.forms[0].refNo.focus();" />
					</td>
			</table>
