...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		var detailArray=new Array(); 
		 ...
		 function getInvestAmt()
		 {
		 	document.forms[0].amountInv.value="";
		 	if(document.forms[0].trustType.value!=""&& document.forms[0].securityCat.value!="" )
			{
			
				var url;
				
			
				var url="/jsp/investment/rbiauction/proposal/LoadInvestAmount.jsp?trustType="+document.forms[0].trustType.value+"&securityCat="+document.forms[0].securityCat.value;
				
			
				sendURL(url,"loadInvestAmt");
				
			}
		}
		function loadInvestAmt()
		{
			if (httpRequest.readyState == 4)
				...
				if(node) 
					...
					var invamt=node.childNodes[0].getElementsByTagName("Amount")[0].firstChild.nodeValue;				
					
					document.forms[0].amountInv.value=invamt;
	...
	{        
		...
		if(httpRequest) {
			...
			httpRequest.open("POST", url, true);  //2nd arg is url with name/value pairs, 3 specify asynchronus communication
...
function clearDetails()
	...
	<body onload="document.forms[0].refNo.focus();">
		<html:form action="/addProposal.do?method=addProposal&mode=rbiauction" method="POST" onsubmit="return validate();">
			...
			<table border=0 align="center" cellspacing="4">
				...
				<tr>
					...
					<td align=left colspan="3">
						<html:textarea property="subject" cols="50" rows="3" tabindex="9" onkeypress="return TxtAreaMaxLength(this.value,2499)"></html:textarea>
					</td>
				</tr>
				<tr>
					<td  class="tableTextBold" align=right nowrap>
				...
				<tr>
					<td colspan=4 align=center>
						...
						&nbsp;
						<html:button styleClass="butt" property="Cancel" value="Cancel" onclick="javascript:window.location.href='searchProposal.do?method=searchInvestProposal&mode=rbiauction'" onblur="document.forms[0].refNo.focus();" tabindex="13" />
					</td>
				</tr>
			</table>
