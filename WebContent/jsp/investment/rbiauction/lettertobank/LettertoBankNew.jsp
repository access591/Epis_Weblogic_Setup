...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			var httpRequest; 
			function validate(){
				if(document.forms[0].proposalSecurity.value==""){
				    alert("Please Enter The Proposal Reference No. (Mandatory)");
				    document.forms[0].proposalSecurity.focus();
				    return false;
			    }
			...
			if(!document.forms[0].proposalSecurity.value=="")
			{
				...
				var url;
				 var refNo=document.forms[0].proposalSecurity.value;
			    refNo=refNo.replace(/%/g,'~');
			    refNo=refNo.replace(/#/g,'ß');
			    
			    
			
				var url="jsp/investment/quotation/LoadTrust.jsp?proposalRefNo="+refNo+"&mode=lettertobank&modetype="+document.forms[0].mode.value;
				...
				if(node) 
					{
						...
						var refNo=node.childNodes[0].getElementsByTagName("RefNo")[0].firstChild.nodeValue;
						var securityfullname=node.childNodes[0].getElementsByTagName("securityFullName")[0].firstChild.nodeValue;
						}
						...
						document.forms[0].securityFullName.value=securityfullname;
						}
	...
	<body onload="document.forms[0].proposalSecurity.focus();">
			...
			<table width="550" border=0 align="center">
				...
				<tr>
					...
					<td align=left width="25%">
						<html:select property="proposalSecurity" onchange="LoadTrustType();" styleClass="TextField" style="width:220px" tabindex="1">
							<html:option value="">[SelectOne]</html:option>
							<html:options collection="proposalList" property="proposalSecurity" labelProperty="proposalSecuritydef" />
						</html:select>
...
<html:text property="bankDate" styleId="bankDate" style="width: 95px;" tabindex="10" styleClass="TextField" />
			...
			<tr>
				...
				<tr>
					...
					<td align=left width="25%">
						<html:text property="securityName" style="width: 200px;" readonly="true" tabindex="9" styleClass="TextField"  />
					...
					<tr>
						...
						<td width="25%" class="tableTextBold" align=right>
						<bean:message key="lettertobank.securityname" bundle="common"/>
						</td>
						<td align=left width="25%">
						<html:text size="12" styleClass="TextField" property="securityFullName" readonly="true"/>
						</td>
