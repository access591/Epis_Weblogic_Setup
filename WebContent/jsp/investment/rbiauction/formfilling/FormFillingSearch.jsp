...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
	   ...
	   if(optiontype!='Add'){
		...
		if(optiontype=='Add'){		 
			 ...
			 window.location.href='searchFormFilling.do?method=showFormFillingAdd&mode=rbiauction';
		 }
		if(optiontype=='Delete'){		 
			 ...
			 if(val[1]=='A'){
			    ...
			    var url = "searchFormFilling.do?method=deleteFormFilling&deleteall="+recordcd+"&mode=rbiauction";
			    ...
			    var url = "searchFormFilling.do?method=showEditFormFilling&formCd="+recordcd+"&mode=rbiauction";
				document.forms[0].action=url;
				document.forms[0].submit();
				}
		 ...
		 {	
		 	if(val[2]=='A'){
		 		...
		 		var url="searchFormFilling.do?method=approvalFormFilling&formCd="+recordcd+"&&edit=Y&mode=rbiauction&updatedFlag=1";
			 	document.forms[0].action=url;
			 	document.forms[0].submit();
		 	}else{	    
			 	var url="searchFormFilling.do?method=approvalFormFilling&formCd="+recordcd+"&mode=rbiauction&updatedFlag=1";
			 	document.forms[0].action=url;
			 	document.forms[0].submit();
		 	}
		 }
		 ...
		 {	
		 	if(val[1]!='A'){
		 		...
		 		var url="searchFormFilling.do?method=approvalFormFilling&formCd="+recordcd+"&&edit=Y&mode=rbiauction&updatedFlag=2";
			 	document.forms[0].action=url;
			 	document.forms[0].submit();
		 	}else{	    
			 	var url="searchFormFilling.do?method=approvalFormFilling&formCd="+recordcd+"&mode=rbiauction&updatedFlag=2";
			 	document.forms[0].action=url;
			 	document.forms[0].submit();
		 	}
		 }
  ...
  function openReport(url){
	...
	<html:form action="/searchFormFilling.do?method=searchFormFilling&mode=rbiauction">
	<%=ScreenUtilities.screenHeader("applicationform.title")%>
			...
			<logic:present name="formfillingList">
				<tr>
					   ...
					   <display:table  cellpadding="0" cellspacing="0"  class="GridBorder"  keepStatus="false" style="width:710px;height:50px" export="true"  sort="list" id="formfillingTable" name="requestScope.formfillingList" requestURI="/searchFormFilling.do?method=searchFormFilling&mode=rbiauction" pagesize="5" >		            		            	            
					   <logic:present name="formfillingTable" >
			            ...
			            <display:column headerClass="GridLTHCells" class="GridLTCells" property="nameofApplicant" sortable="true" title="Name of Applicant" decorator="com.epis.utilities.StringFormatDecorator" />
			            ...
			            <display:column headerClass="GridHBg" class="GridLTCells" media="html">
						 <img src='images/print.gif' border='0' alt='Report' onclick="openReport('/FormFillingReport.do?method=generateFormFillingReport&&mode=rbiauction&formCd=<%=((FormFillingBean)pageContext.getAttribute("formfillingTable")).getFormCd()%>');" />
						</display:column>
			            </logic:present>
			        	</display:table>
			        </td>
