...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	var url = "investmentReports.do?method=reportIntersetDetail&frmDT="+document.forms[0].fromDate.value+"&toDT="+document.forms[0].toDate.value+"&trust="+document.forms[0].trustType.value+"&security="+document.forms[0].securityName.value+"&reportType="+document.forms[0].reportType.value;
...
wind1.window.focus();
 ...
 function closeWin() {
	...
	<%=ScreenUtilities.screenHeader("report.intersetdetails")%>
