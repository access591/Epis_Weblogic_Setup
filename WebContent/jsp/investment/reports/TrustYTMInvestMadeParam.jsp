...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<SCRIPT type="text/javascript">
		 ...
		 if(document.forms[0].fromDate.value!="")
			fromdate=FormatDate(document.forms[0].fromDate.value);
		if(document.forms[0].toDate.value==""){
		    alert("To Date is Mandatory");
		    return false;
		  }	
		 if(document.forms[0].toDate.value!="")
			todate=FormatDate(document.forms[0].toDate.value);
		
	var url = "investmentReports.do?method=TrustYTMInvestMadeReport&trusttype="+document.forms[0].trustType.value+"&fromDate="+fromdate+"&toDate="+todate+"&reportType="+document.forms[0].reportType.value;
...
wind1.window.focus();
 ...
 function closeWin() {
	...
	<%=ScreenUtilities.screenHeader("report.naaecpf")%>
