...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<SCRIPT type="text/javascript">
		 var vWinCal;
		 function validate(){
	var url = "investmentReports.do?method=TrustInvestmentMadeReport&trusttype="+document.forms[0].trustType.value+"&date="+document.forms[0].year.value+"&reportType="+document.forms[0].reportType.value;
...
wind1.window.focus();
 ...
 function closeWin() {
  ...
  function loadYears()
	...
	<%=ScreenUtilities.screenHeader("report.paramtitle")%>
			<table width="550" border="0" cellspacing="3"  cellpadding="3">
				...
				<tr>                    
			 	 <td  class="tableTextBold" width="50%" align=right nowrap colspan=3><bean:message key="proposal.trusttype" bundle="common"/>:</td>
                 <td align=left colspan=3>
                 <html:select  property="trustType" styleClass="TextField" style="width:120 px" tabindex="4" >
						...
						<html:options collection="trustList" property="trustType" labelProperty="trustType"/>
                      	...
                      	<tr>
				<td  align=right class="tableTextBold" nowrap colspan=3>
				...
				<tr>
					<td class="tableTextBold" align="right" colspan=3>
