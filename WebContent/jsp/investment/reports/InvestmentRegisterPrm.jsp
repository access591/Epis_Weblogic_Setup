...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	var url = "investmentReports.do?method=InvestmentRegisterReport&investDate="+document.forms[0].investmentDate.value+"&securityNames="+document.forms[0].securityNames.value+"&finYear="+document.forms[0].finYear.value+"&securityCd="+document.forms[0].securityCategoryId.value+"&interestMonth="+document.forms[0].interestMonthList.value+"&maturityMonth="+document.forms[0].maturityMonth.value+"&maturityYear="+document.forms[0].maturityYear.value+"&fromDate="+document.forms[0].fromDate.value+"&toDate="+document.forms[0].toDate.value+"&reportType="+document.forms[0].reportType.value;
			...
			<table width="550" border="0" cellspacing="3" cellpadding="0">
				...
				<tr>
					...
					<td width="15%" align=right class="tableTextBold" nowrap>
						<bean:message key="report.dateofinvestfrom" bundle="common"/> : 
						</td>
						<td width="15%" nowrap>
						...
						<td>&nbsp;</td>
						<td width="15%" align=right class="tableTextBold" nowrap>
						<bean:message key="report.dateofinvestto" bundle="common"/> : 
						</td>
						<td width="15%" nowrap>
