...
<html>
	...
	<body><br><FIELDSET ><LEGEND class="epis">Shortlisting Arrangers</LEGEND>
	<table width="70%" border=0 align="center">
		<tbody>
			...
			<tr>
				...
				<td  width="20%" class="epis" align=right nowrap>
					 Status :
                        ...
                        <option value="r"> Not Shortlisted</option>                         
			...
			<tr>
			<td  colspan=4 align=center><input type="button" value="Search" onclick="javascript:window.location.href='<%=basePath%>jsp/investment/shortlist/ShortListedArrangersSearchResult.jsp'"><input type="button" value="Clear">
			<!-- 
			...
			<tr>
				<td colspan=4 align=left><input type="button" value="Add" onclick="javascript:window.location.href='<%=basePath%>jsp/investment/shortlist/ShortListedArrangersNew.jsp'"><input type="button" value="Delete">
				</td>
			</tr>
				<tr>
				<td colspan=4 align=center>
				<TABLE width=100% border=0 cellpadding=0 cellspacing=0  bordercolor="#d6dbe2" >
				<tr bgcolor="#d6dbe2"><td width=20 >&nbsp;</td><td class="epis" width=100>Letter No.</td><td width=100 class="epis">&nbsp;</td><td class="epis" width=100></td><td width=20>&nbsp;</td><td width=200 class="epis">Shortlisted</td><td width=100 class="epis">&nbsp;</td><td class="epis" width=100></td><td width=100 class="epis">&nbsp;</td></tr>
