...
<html>
	...
	<body><br><FIELDSET ><LEGEND class="epis">Investment Approval</LEGEND>
	<table width="70%" border=0 align="center">
		<tbody>
			...
			<tr>
			<td  colspan=4 align=center><input type="button" value="Search" onclick="javascript:window.location.href='<%=basePath%>jsp/investment/approval/InvestmentApprovalSearchResult.jsp'"><input type="button" value="Clear">
			<!-- 
			...
			<tr>
				<td colspan=4 align=left><input type="button" value="Add" onclick="javascript:window.location.href='<%=basePath%>jsp/investment/approval/InvestmentApprovalNew.jsp'"><input type="button" value="Delete">
				</td>
			</tr>
				<tr>
				<td colspan=4 align=center>
				<TABLE width=100% border=0 cellpadding=0 cellspacing=0  bordercolor="#d6dbe2" >
				<tr bgcolor="#d6dbe2"><td width=20 >&nbsp;</td><td class="epis" width=100>Letter No.</td><td width=100 class="epis">&nbsp;</td><td width=20>&nbsp;</td><td width=100 class="epis">Approved</td><td class="epis" width=10></td><td width=100 class="epis">Approved By</td><td width=20 class="epis">&nbsp;</td><td class="epis" width=150>Date Of Approval</td></tr>
