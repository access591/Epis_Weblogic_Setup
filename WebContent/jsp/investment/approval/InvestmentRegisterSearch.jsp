...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		if(optiontype=='Add'){		 
			 ...
			 window.location.href='/investregister.do?method=showRegisterLetters';
		 }
  ...
  function openReport(url){
				...
				var wind1 = window.open(url,"InvestmentRegister","toolbar=yes,statusbar=yes,scrollbars=yes,menubar=yes,resizable=yes,width="+swidth+",height="+sheight+",top=0,left=0");
			}
	...
	<html:form action="/searchinvestregister.do?method=searchInvestRegister" onsubmit="return validate();">
	<%=ScreenUtilities.screenHeader("investmentRegister.title")%>
			...
			<logic:present name="investmentRegisterList">
				<tr>
					   ...
					   <display:table  cellpadding="0" cellspacing="0"  class="GridBorder"  keepStatus="false" style="width:710px;height:50px" export="true"  sort="list" id="investmentRegisterTable" name="requestScope.investmentRegisterList" requestURI="/searchinvestregister.do?method=searchInvestRegister" pagesize="5" >		            		            	            
					   <logic:present name="investmentRegisterTable" >
			            ...
			            <display:column headerClass="GridHBg" class="GridLTCells" media="html">
						 <img src='images/print.gif' border='0' alt='Report' onclick="openReport('/searchinvestregister.do?method=generateInvestRegisterReport&&registerCd=<%=((InvestmentRegisterBean)pageContext.getAttribute("investmentRegisterTable")).getRegisterCd()%>');" />
						</display:column>
			            </logic:present>
			        	</display:table>
			        </td>
