	...
	function calPurchaseValue()
{
	...
	if(document.forms[0].premiumPaid.value!="" && parseFloat(document.forms[0].premiumPaid.value)!=0){
		if(!ValidateFloatPoint(document.forms[0].premiumPaid.value,12,4)){
...
function caluculatePremiumPaid()
{
	if(document.forms[0].faceValue.value!=""&& document.forms[0].offeredPrice.value!="")
	{
		...
		if(!ValidateFloatPoint(document.forms[0].offeredPrice.value,14,4)){
...
document.forms[0].interestDate1.options[document.forms[0].interestDate1.options.length]	=	new Option(parseInt(i),parseInt(i));
	...
	<body  onload="document.forms[0].refNo.focus();displayRemarks();displayCalldate();displayinterestDate();displayPurchase();getInvestSecurity();displayIncentive();">
				<html:form action="/addInvestmentRegisterManual.do?method=addInvestmentRegisterManual" onsubmit="return validate();">
			...
			<table width="550" border=0 align="center" bordercolor=red>
				...
				<tr>
					...
					<td align=left >
						<html:select property="trustType" style="width:150px" tabindex="2" styleClass="TextField">
					...
					<td align=left >
						<html:select property="marketType" styleClass="TextField" style="width:150px" tabindex="4">
						<html:option value="">[ Select One ]</html:option>
					...
					<td align=left  nowrap="nowrap">
						<html:text property="amountInv" styleClass="TextField" style="width:120px" tabindex="5" maxlength="18" />
					...
					<html:text property="ISIN" styleClass="TextField" style="width:120px" tabindex="5" maxlength="20" />
				...
				<td  align=left width="20%" styleClass="tableText"  nowrap>
				 ...
				 <input type=radio name="exist" value="N" onclick="getInvestSecurity();" checked="checked" />
				  <div id="cashDiv"></div>	
					...
					<td align=left width="25%">
					<html:text property="dealDate" styleId="dealDate" style="width: 95px;" tabindex="7" styleClass="TextField" />
							<html:link href="javascript:showCalendar('dealDate');" tabindex="8">
				...
				<td align=left width="25%">
				<html:text property="settlementDate" styleId="settlementDate" style="width: 95px;" tabindex="9" styleClass="TextField" />
						<html:link href="javascript:showCalendar('settlementDate');" tabindex="10">
							<html:img src="images/calendar.gif" alt="Datepicker" border="0" align="center" />
						</html:link>
				</td>
				...
				<td width="25%" align="left">
						<html:text property="maturityDate" onblur="getYTMValue();" styleId="maturityDate" style="width: 95px;" tabindex="11" styleClass="TextField" />
						<html:link href="javascript:showCalendar('maturityDate');" tabindex="12">
							<html:img src="images/calendar.gif" alt="Datepicker" border="0" align="center" />
						</html:link>
					</td>
			...
			<td width="25%" class="tableTextBold" align=right nowrap >
					...
					<td align=left width="25%" >
						<html:text property="cuponRate" onblur="getYTMValue();" size="12" styleClass="TextField" style="width:160 px" tabindex="13" maxlength="8" value="0"/>
				...
				<td width="25%" class="tableTextBold" align=right nowrap>
					...
					<td align=left width="25%" nowrap>
						<html:text size="12" property="faceValue" onblur="caluculatePremiumPaid();calPurchaseValue();getYTMValue();" styleClass="TextField" style="width:120 px" maxlength="15" tabindex="14"  value="0"/>
				...
				<td width="25%" class="tableTextBold" align=right nowrap>
					...
					<html:text size="12" property="noofBonds" onblur="calPurchaseValue();getYTMValue();" styleClass="TextField" style="width:120 px"  tabindex="15" maxlength="12" value="0" />
					</td>
					...
					<td align=left width="25%">
					<html:text size="12" property="offeredPrice" styleClass="TextField" style="width:120 px" onblur="caluculatePremiumPaid();getYTMValue();"  tabindex="16" maxlength="8"  value="0"/>
					</td>
					...
					<td align=left width="25%">
					<html:text size="12" property="premiumPaid" onblur="calPurchaseValue();getYTMValue();" styleClass="TextField" style="width:120 px"  tabindex="17" maxlength="6" value="0"  />
					</td>
					...
					<td align=left width="25%">
					<html:text size="12" property="purchasePrice" styleClass="TextField" style="width:120 px"  tabindex="18" maxlength="16" value="0" />
					</td>
					...
					<td width="25%" class="tableTextBold" align="right" nowrap>
						...
						<td width="25%" align="left">
						<html:select property="modeOfInterest" onchange="displayinterestDate();getYTMValue();"  styleClass="TextField" style="width:200 px" tabindex="19">
					...
					<td align=left width="25%">
					<html:text size="12" property="ytmValue" styleClass="TextField" style="width:120 px"  tabindex="21" maxlength="6" value="0"  />
					</td>
					</tr>
						<tr>
						<td width="25%" class="tableTextBold" align="right" nowrap>
						...
						<html:select property="interestMonth"  onchange="LoadDates();" styleClass="TextField" tabindex="22" style="width:50px">
							<html:option value="">[select One]</html:option>
							<html:options collection="interestMonthsList" property="code"  labelProperty="name" />
						</html:select>
						
						<html:select property="interestDate"  styleClass="TextField" tabindex="23" style="width:50px">
							<html:option value="">[select One]</html:option>
						...
						<html:select property="interestMonth1" onchange="LoadDates1();"  styleClass="TextField" tabindex="24" style="width:50px">
							<html:option value="">[select One]</html:option>
							<html:options collection="interestMonthsList" property="code"  labelProperty="name" />
						</html:select>
						
						<html:select property="interestDate1"  styleClass="TextField" tabindex="25" style="width:50px">
							<html:option value="">[select One]</html:option>
					...
					<td align="left" width="25%">
					<html:text property="arrangerName" styleClass="TextField" style="width: 160px;" maxlength="200" tabindex="17"  />
					</td>
					<td width="25%" class="tableTextBold" align="right" nowrap>
					<font color=red>*</font>
					...
					<td align="left" width="25%">
					<html:text property="incentivetext" styleClass="TextField" maxlength="20" />
					</td>
					<td colspan=2>&nbsp;</td>
					...
					<td align=left width="25%">
						<html:text property="accuredInterestAmount"  style="width: 120px;" value="0" maxlength="16" tabindex="14" styleClass="TextField"  />
					...
					<td colspan=2>&nbsp;<html:hidden property="mode" name="registerBean"/></td>
					</tr>
