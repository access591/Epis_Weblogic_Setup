...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		if(optiontype=='Add'){		 
			 ...
			 window.location.href='searchInvestmentRegister.do?method=showInvestmentRegisterManualAdd&mode=<%=mode%>';
		 }
				...
				<tr>
					   ...
					   <logic:present name="investmentRegisterTable" >
			            ...
			            <display:column headerClass="GridHBg" class="GridLTCells" media="html">
						 <a href='/editInvestmentRegister.do?method=editInvestmentRegister&registerCd=<%=((InvestmentRegisterBean)pageContext.getAttribute("investmentRegisterTable")).getRegisterCd()%>'> <img src='images/icon-edit.gif' border='0' alt='Edit' /> </a>
						</display:column>
			            <display:column headerClass="GridHBg" class="GridLTCells" media="html">
