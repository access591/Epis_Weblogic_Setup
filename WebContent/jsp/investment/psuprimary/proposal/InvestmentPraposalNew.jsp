...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="document.forms[0].refNo.focus();">
		<html:form action="/addProposal.do?method=addProposal&mode=psuprimary" method="POST" onsubmit="return validate();">
			...
			<table border=0 align="center" cellspacing="4">
				...
				<tr>
					<td colspan=4 align=center>
						...
						&nbsp;
						<html:button styleClass="butt" property="Cancel" value="Cancel" onclick="javascript:window.location.href='searchProposal.do?method=searchInvestProposal&mode=psuprimary'" onblur="document.forms[0].refNo.focus();" tabindex="13" />
					</td>
				</tr>
			</table>
