...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="document.forms[0].approveDate.focus();">
		<html:form action="/approvalProposal.do?method=approvalUpdate&mode=psuprimary" onsubmit="return validate();">
...
<html:hidden property="edit" value="<%=edit%>" />
				<tr>
					<td colspan=4 align=center>
						...
						<html:button styleClass="butt" property="Cancel" value="Cancel" onclick="javascript:window.location.href='searchProposal.do?method=searchInvestProposal&mode=psuprimary'" onblur="document.forms[0].refNo.focus();" />
					</td>
			</table>
