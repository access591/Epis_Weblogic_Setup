  ...
  function selectCheckboxes(optiontype) { 
	   ...
	   if(optiontype!='Add'){
		...
		if(optiontype=='Add'){		 
			 ...
			 window.location.href='searchProposal.do?method=showProposalAdd&mode=psuprimary';
		 }
		if(optiontype=='Delete'){		 
			...
			if(state){
				if(val[1]=='A'){
				    ...
				    var url = "searchProposal.do?method=deleteProposal&deleteall="+recordcd+"&mode=psuprimary";
				...
				return;
		 		...
		 		if(val[1]=='A'){
				    ...
				    var url = "searchProposal.do?method=showEditProposal&refNo="+recordcd+"&mode=psuprimary";
					document.forms[0].action=url;
					document.forms[0].submit();
				}			 
		 }
		 ...
		 {	
		 	if(val[2]=='A'){
		 		...
		 		var url="searchProposal.do?method=approvalProposal&refNo="+recordcd+"&&edit=Y&mode=psuprimary&updatedFlag=1";
			 	document.forms[0].action=url;
			 	document.forms[0].submit();
		 	}else{	    
			 	var url="searchProposal.do?method=approvalProposal&refNo="+recordcd+"&mode=psuprimary&updatedFlag=1";
			 	document.forms[0].action=url;
			 	document.forms[0].submit();
		 	}
		 }
		 ...
		 {	
		 	if(val[1]!='A'){
		 		...
		 		var url="searchProposal.do?method=approvalProposal&refNo="+recordcd+"&&edit=Y&mode=psuprimary&updatedFlag=2";
			 	document.forms[0].action=url;
			 	document.forms[0].submit();
		 	}else{	    
			 	var url="searchProposal.do?method=approvalProposal&refNo="+recordcd+"&mode=psuprimary&updatedFlag=2";
			 	document.forms[0].action=url;
			 	document.forms[0].submit();
		 	}
		 }
		 ...
		 {		    
		 	if(val[2]!='A'){
		 		...
		 		var url="searchProposal.do?method=approvalProposal&refNo="+recordcd+"&&edit=Y&mode=psuprimary&updatedFlag=3";
			 	document.forms[0].action=url;
			 	document.forms[0].submit();
		 	}else{	    
			 	var url="searchProposal.do?method=approvalProposal&refNo="+recordcd+"&mode=psuprimary&updatedFlag=3";
			 	document.forms[0].action=url;
			 	document.forms[0].submit();
		 	}
		 }
		 ...
		 {		    
		 	if(val[3]!='A'){
		 		...
		 		var url="searchProposal.do?method=approvalProposal&refNo="+recordcd+"&&edit=Y&mode=psuprimary&updatedFlag=4";
			 	document.forms[0].action=url;
			 	document.forms[0].submit();
		 	}else{	    
			 	var url="searchProposal.do?method=approvalProposal&refNo="+recordcd+"&mode=psuprimary&updatedFlag=4";
			 	document.forms[0].action=url;
			 	document.forms[0].submit();
		 	}
		 }
		 ...
		 {		    
		 	if(val[4]!='A'){
		 			...
		 			var url="searchProposal.do?method=approvalProposal&refNo="+recordcd+"&&edit=Y&mode=psuprimary&updatedFlag=5";
				 	document.forms[0].action=url;
				 	document.forms[0].submit();
		 	}else{	    
			 	var url="searchProposal.do?method=approvalProposal&refNo="+recordcd+"&mode=psuprimary&updatedFlag=5";
			 	document.forms[0].action=url;
			 	document.forms[0].submit();
		 	}
		 }
		 ...
		 {		    
		 	if(val[4]!='A'){
		 			...
		 			var url="searchProposal.do?method=approvalProposal&refNo="+recordcd+"&&edit=Y&mode=psuprimary&updatedFlag=6";
				 	document.forms[0].action=url;
				 	document.forms[0].submit();
		 	}else{	    
			 	var url="searchProposal.do?method=approvalProposal&refNo="+recordcd+"&mode=psuprimary&updatedFlag=6";
			 	document.forms[0].action=url;
			 	document.forms[0].submit();
		 	}
		 }
		 ...
		 {		    
		 	if(val[4]!='A'){
		 			...
		 			var url="searchProposal.do?method=approvalProposal&refNo="+recordcd+"&&edit=Y&mode=psuprimary&updatedFlag=7";
				 	document.forms[0].action=url;
				 	document.forms[0].submit();
		 	}else{	    
			 	var url="searchProposal.do?method=approvalProposal&refNo="+recordcd+"&mode=psuprimary&updatedFlag=7";
			 	document.forms[0].action=url;
			 	document.forms[0].submit();
		 	}
		 }
	...
	<body onload="document.forms[0].refNo.focus();">
		<html:form action="/searchProposal.do?method=searchInvestProposal&mode=psuprimary" onsubmit="return validate();">
					...
					<tr>
						<td align="left" valign="top">
							...
							<display:table cellpadding="0" cellspacing="0" class="GridBorder" keepStatus="false" style="width:710px;height:50px" export="true" sort="list" id="proposalTable" name="requestScope.proposalList"
								requestURI="/searchProposal.do?method=searchInvestProposal&mode=psuprimary" pagesize="5">
				            ...
				            <display:column property="trustType" headerClass="GridLTHCells" class="GridLTCells" sortable="true" title="Trust" />
								...
								<display:column headerClass="GridHBg" class="GridLTCells" media="html">
									<img src='images/print.gif' border='0' alt='Report' onclick="openReport('/initialproposal.do?method=getReport&&refNo=<%=((InvestmentProposalBean)pageContext.getAttribute("proposalTable")).getRefNo()%>');" />
								</display:column>
								</logic:present>
							</display:table>
