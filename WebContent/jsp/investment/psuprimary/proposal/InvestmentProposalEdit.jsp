...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="document.forms[0].refNo.focus();">
		<html:form action="/editProposal.do?method=editProposal&mode=psuprimary" method="POST" onsubmit="return validate();" enctype="multipart/form-data">
			...
			<table width="550" border=0 align="center">
				...
				<tr>
					<td colspan=4 align=center>
						...
						<html:button styleClass="butt" property="Cancel" value="Cancel" onclick="javascript:window.location.href='searchProposal.do?method=searchInvestProposal&mode=psuprimary'" onblur="document.forms[0].refNo.focus();" tabindex="11" />
					</td>
				</tr>
			</table>
