...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="document.forms[0].approveDate.focus();">
		<html:form action="/approvalformfilling.do?method=approvalUpdate&mode=PSUPrimary" onsubmit="return validate();">
...
<html:hidden property="edit" value="<%=edit%>" />
				<tr>
					<td colspan=4 align=center>
						...
						<html:button styleClass="butt" property="Cancel" value="Cancel" onclick="javascript:window.location.href='searchFormFilling.do?method=searchFormFilling&mode=PSUPrimary'" onblur="document.forms[0].securityName.focus();" />
					</td>
			</table>
