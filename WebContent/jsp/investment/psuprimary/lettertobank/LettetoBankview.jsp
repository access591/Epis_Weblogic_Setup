...
<%@ page language="java" import="com.epis.utilities.ScreenUtilities,java.text.*" pageEncoding="UTF-8"%>
...
LetterToBankBean bean=(LetterToBankBean)request.getAttribute("letterToBankBean");
...
<html>
  ...
  <body >
   ...
   <tr>
    ...
    <bean:define id="bankfulladdress" name="letterToBankBean" property="bankAddress" type="java.lang.String" />
    
    <%=sh.newLineAddress(bankfulladdress)%>
    ...
    <tr>
    <td colspan="3" align="justify" class="reportsublabel">&nbsp;&nbsp;&nbsp; Kindly arrange to deposit the SGL Form,which will receive from the following counterpart with the Reserve Bank Of India and credit our  accountno.<bean:write name="letterToBankBean" property="aaiaccountNo"/> with you.
    ...
    <tr>
     ...
     :</td>
     <td align="left" class="reportsublabel" width="40%" >
     <bean:write name="letterToBankBean" property="securityFullName"/>
