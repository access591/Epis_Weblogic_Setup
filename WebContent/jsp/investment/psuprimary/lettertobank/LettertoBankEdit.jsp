...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			...
			if(!document.forms[0].refNo.value=="")
			{
				...
				var url="jsp/investment/quotation/LoadTrust.jsp?proposalRefNo="+document.forms[0].refNo.value;
				...
				if(node) 
					{
						...
						var securityId=node.childNodes[0].getElementsByTagName("securityId")[0].firstChild.nodeValue;
	...
	<body>
		<html:form action="/editlettertobank.do?method=editletterbank" onsubmit="return validate();">
			...
			<table width="550" border=0 align="center">
				...
				<tr>
					...
					<td align=left width="25%">
						<bean:write property="refNo" name="letterbean"/>
					...
					<td align=left width="25%">
						<bean:write property="trustType" name="letterbean"/>
					</td>
					</tr>
					<tr>
					<td width="25%" class="tableTextBold" align=right nowrap>
					...
					<td align=left width="25%">
						<bean:write property="securityCategory" name="letterbean"/>		
					...
					<td align=left width="25%">
					    <bean:write property="marketTypedef" name="letterbean"/>
					</td>
					...
					<td width="25%" class="tableTextBold" align=right nowrap>
					 ...
					 <bean:write property="bankName" name="letterbean"/>
                        </td>
					...
					<td align=left width="25%">
					 <bean:write property="accountNo" name="letterbean"/>
					</td>
				...
				<td width="25%" class="tableTextBold" align=right nowrap>
					...
					<td align=left width="25%">
					     <bean:write property="branchName" name="letterbean"/>
					</td>
					...
					<td align=left width="25%">
					     <bean:write property="accountTypedef" name="letterbean"/>
...
<td align=left width="25%">
<html:text property="bankDate" name="letterbean" styleId="bankDate" style="width: 95px;" tabindex="1" styleClass="TextField" />
						<html:link href="javascript:showCalendar('bankDate');" tabindex="2">
					...
					<td align=left width="25%" >
						<html:text property="beneficiaryName" name="letterbean" size="12" styleClass="TextField" style="width:160 px" tabindex="3" maxlength="100"/>
			...
			<tr>
				...
				<td width="25%" class="tableTextBold" align=right nowrap>
					...
					<td align=left width="25%" nowrap="nowrap">
						<html:text size="12" property="creditAccountNo" name="letterbean" styleClass="TextField" style="width:120 px" maxlength="20" tabindex="4"  />
					...
					<html:text size="12" property="centerLocation" name="letterbean" styleClass="TextField" style="width:120 px"  tabindex="5" maxlength="50"  />
					</td>
				</tr>
				...
				<tr>
					...
					<td align=left width="25%">
						<html:text size="12" property="remitanceAmt" name="letterbean" styleClass="TextField" style="width:160 px" maxlength="16" tabindex="6" />
					</td>
					<td   width="25%" class="tableTextBold" align=right nowrap>
						<font color=red>*</font>
					...
					<td align=left width="25%">
						<html:textarea property="remarks" name="letterbean" rows="3" cols="15" style="WIDTH: 200 px" onkeypress="return TxtAreaMaxLength(document.forms[0].remarks.value,999)" tabindex="7" />
				...
				<tr>
					...
					<td align=left width="25%">
						<html:text property="sglAccountNo" name="letterbean" style="width: 120px;" readonly="true" tabindex="5" styleClass="TextField" />
					...
					<td align=left width="25%">
					    <html:text size="12" property="sellerRefNo" name="letterbean" styleClass="TextField" style="width:120 px" maxlength="20" tabindex="6" />
					...
					<td align=left width="25%">
						<html:text property="dealDate" name="letterbean" style="width: 120px;" readonly="true" tabindex="7" styleClass="TextField" />
					...
					<td align=left width="25%">
					    <html:text size="12" property="settlementDate" name="letterbean" styleClass="TextField" style="width:120 px"  tabindex="8" readonly="true" />
					...
					<td align=left width="25%">
						<html:text property="securityName" name="letterbean" style="width: 120px;" readonly="true" tabindex="9" styleClass="TextField"  />
					...
					<td align=left width="25%">
					    <html:text size="12" property="faceValue" name="letterbean" styleClass="TextField" style="width:120 px"  tabindex="10" readonly="true" />
					...
					<td align=left width="25%">
						<html:text property="offeredPrice" name="letterbean" style="width: 120px;" readonly="true" tabindex="11" styleClass="TextField"  />
					...
					<td align=left width="25%">
					    <html:text size="12" property="principalAmount" name="letterbean" styleClass="TextField" style="width:120 px"  tabindex="12" readonly="true" />
					...
					<td align=left width="25%">
						<html:text property="noofdays" name="letterbean" style="width: 120px;" maxlength="3" tabindex="13" styleClass="TextField"  />
					...
					<td align=left width="25%">
						<html:text property="accuredInterestAmount" name="letterbean" onchange="caluculateSettlementAmount();" style="width: 120px;" maxlength="16" tabindex="14" styleClass="TextField"  />
					...
					<td align=left width="25%">
					    <html:text size="12" property="settlementAmount" name="letterbean" styleClass="TextField" style="width:120 px" maxlength="16" readonly="true" tabindex="15"  />
				...
				<td width="25%" class="tableTextBold" align=right nowrap>
					...
					<td align=left width="25%" nowrap="nowrap">
						<html:text size="12" property="leftSign" name="letterbean" styleClass="TextField" style="width:120 px" maxlength="25" tabindex="8"  />
					...
					<td align=left width="25%" nowrap="nowrap">
						<html:text size="12" property="rightSign" name="letterbean" styleClass="TextField" style="width:120 px" maxlength="25" tabindex="9"  />
				...
				<tr>
				<td  colspan=4 align=center id="displayNone">&nbsp;<html:hidden property="letterNo" name="letterbean"/><input type="hidden" name="mode" value="<bean:write name="modeType" scope="request"/>"/></td>
				</tr>

				<tr>
					<td colspan=4 align=center>
						<html:submit styleClass="butt" tabindex="10">
							<bean:message key="button.save" bundle="common" />
						</html:submit>
						&nbsp;
						<html:button styleClass="butt" property="Clear" tabindex="11" onclick="clearData();">Clear </html:button>
						<html:button styleClass="butt" property="Cancel" value="Cancel" onclick="javascript:window.location.href='searchLettertoBank.do?method=searchLettertoBank&mode='+document.forms[0].mode.value" onblur="document.forms[0].refNo.focus();" tabindex="12" />
					</td>
				</tr>
