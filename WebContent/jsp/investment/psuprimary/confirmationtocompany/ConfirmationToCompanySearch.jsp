	...
	<head>
	   ...
	   if(optiontype!='Add'){
		...
		if(optiontype=='Add'){		 
			 ...
			 window.location.href='searchConfirmationCompany.do?method=showConfirmationCompanyAdd&mode=<%=mode%>';
		 }
			...
			<logic:present name="confirmationcompanyList">
				<tr>
					   ...
					   <logic:present name="confirmationcompanyTable" >
					    ...
					    <display:column  media="html" style="width:10px" headerClass="GridHBg" class="GridLCells">
					    <input type="radio" style="width:15px;height:px" name="selectall" value="<bean:write name="confirmationcompanyTable" property="letterNo"/>|<bean:write name="confirmationcompanyTable" property="confirm"/>|<bean:write name="confirmationcompanyTable" property="flags"/>">
					     </display:column>
					     </logic:notEqual>
