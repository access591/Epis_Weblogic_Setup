...
function caluculatePremiumPaid()
{
	...
	<body onload="document.forms[0].refNo.focus();displayRemarks();displayCalldate();displayinterestDate();displayPurchase();">
		<html:form action="/addConfirmationCompany.do?method=addConfirmationCompany" onsubmit="return validate();">
				...
				<tr>
					...
					<td align=left width="25%">
						<html:select property="refNo" onchange="LoadTrustType();" styleClass="TextField" style="width:200 px" tabindex="1">
							...
							<html:options collection="proposalList" property="refNo" labelProperty="refNo" />
						</html:select>
					...
					<td align=left width="25%">
					<html:select property="confirm" onchange="displayRemarks();" styleClass="TextField" style="width:200 px" tabindex="5">
							<html:option value="">[SelectOne]</html:option>
			...
			<td width="25%" class="tableTextBold" align=right nowrap >
				...
				<td width="25%" class="tableTextBold" align=right nowrap>
					...
					<td colspan=2>&nbsp;<html:hidden property="mode" name="confirmationbean"/></td>
					</tr>
