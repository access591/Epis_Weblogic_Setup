...
<html>
	...
	<table width="70%" border=0 align="center" cellpadding="4">
				...
				<tr>
					<td>
						...
						<tr>
							...
							<td class="tblabel" align="left" width="25%" nowrap>
							<logic:equal name="confirmationbean" property="purchaseOption" value="P">
							<bean:message key="confirmationcomapny.premiumpaidperunit" bundle="common"/>
							</logic:equal>
							<logic:equal name="confirmationbean" property="purchaseOption" value="D">
						...
						<tr>
							...
							<td  align="left" width="25%" nowrap>
							<bean:write property="securityName" name="confirmationbean"/>
							</td>
							...
							<td align="left" width="25%" nowrap>
							<bean:write property="securityFullName" name="confirmationbean"/>
							</td>
				...
				<tr>
					...
					<bean:define id="conrem" name="confirmationbean" property='confirmationRemarks' type="String"></bean:define>
				...
				<td align="left" nowrap>
					...
					<bean:write name="confirmationbean" property="confirmationDate"/>
				</td>
				</tr>
