...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<html:form action="/editSCategory.do?method=updateSecurityCategory" onsubmit="return validate();" >
           ...
           <tr>
			...
			<tr>
				<td  width="20%" class="tableTextBold" align=right nowrap>
				    <html:hidden name="category" property="categoryId"/>
					<font color=red>*</font><bean:message key="category.categorycd" bundle="common"/>:
				</td><td width="20%" align="left">
					<html:text name="category" size="12" property="categoryCd" styleClass="TextField" style="width:120 px" tabindex="1" maxlength="7"/>
				...
				<td  width="20%" class="tableTextBold" align=right nowrap>
					...
					<html:select property="openingbal" styleClass="TextField" tabindex="2" style="width:200 px" name="category" >
			...
			<tr>
				<td  width="20%" class="tableTextBold" align=right nowrap>
					...
					<html:select property="investinterest" styleClass="TextField" tabindex="3" style="width:200 px"  name="category">
						 <html:option value="">[Select One]</html:option>
						 <html:options collection="accHeadList" property="accHeads" labelProperty="accHeads"/>
                    </html:select>
				...
				<td  width="20%" class="tableTextBold" align=right nowrap>
					...
					<html:select property="investbaseamt" styleClass="TextField" tabindex="4" style="width:200 px"  name="category">
						 <html:option value="">[Select One]</html:option>
						 <html:options collection="accHeadList" property="accHeads" labelProperty="accHeads"/>
                    </html:select>
				</td>	
				...
				<td  width="20%" class="tableTextBold" align=right nowrap>
					...
					<html:text size="12" name="category" property="description" styleClass="TextField"  style="width:180 px" tabindex="5" maxlength="100"/>	
				</td>							
			</tr>
			<tr>
				<td colspan=4 align=center>&nbsp;
			...
			<tr>
			<td  colspan=4 align=center><html:submit styleClass="butt" property="Save" value="Save"  tabindex="6"/>&nbsp;<html:button styleClass="butt" property="Clear" value="Clear" tabindex="7" onclick="clearData();"/>
