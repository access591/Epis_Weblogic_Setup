...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<base href="<%=basePath%>">
		<title>Admin - Approval New Page</title>
	...
	<html:form action="/addApproval.do?method=addApproval" onsubmit="return validate();">
		...
		<tbody >
			...
			<tr>
				<td  width="20%" class="tableTextBold" align=right nowrap>
					...
					<html:text size="12" property="approvalName" styleClass="TextField" style="width:120 px" tabindex="1" maxlength="200" />		
				</td>	
				<td  width="20%" class="tableTextBold" align=right nowrap>
			...
			<td  colspan=4 align=center>
				...
				<html:button  property="Clear"  styleClass="butt"  tabindex="4" onclick="clearData();"><bean:message key="button.clear" bundle="common"/></html:button>
			<html:button  property="Cancel" tabindex="5" styleClass="butt"  onclick="javascript:window.location.href='searchApproval.do?method=searchApproval'" onblur="document.forms[0].approvalName.focus();" ><bean:message key="button.cancel" bundle="common"/></html:button>
			</td>	
			</tr>
			<tr>
				<td colspan=4 align=center>&nbsp;
