...
<%@ page import="com.epis.bean.admin.SMBean"%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function clearData(){
        	 ...
        	 document.forms[0].modules.value="";       	 
  		}
		</SCRIPT>
	</head>
	<body onload="document.forms[0].roleName.focus();" >
	<html:form action="/addRole.do?method=addRole" onsubmit="return validate();">
		...
		<tbody >
			...
			<tr>
				<td  width="20%" class="tableTextBold" align=right nowrap>
					...
					<html:text size="12" property="roleName" styleClass="TextField" style="width:120 px" tabindex="2" maxlength="300" />		
				</td>	
				<td  width="20%" class="tableTextBold" align=right nowrap>
					<bean:message key="role.roledescription" bundle="common"/>:
				</td><td width="20%" align="left">
					<html:text size="12" property="roleDescription" styleClass="TextField" style="width:120 px" tabindex="2" maxlength="300" />		
				</td>			
			</tr>	
			<tr>
			...
			<td  colspan=4 align=center>
				...
				<html:button styleClass="butt" property="Clear" tabindex="5" onclick="clearData();"><bean:message key="button.clear" bundle="common"/></html:button>
