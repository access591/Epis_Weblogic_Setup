...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<html:form action="/addRegion.do?method=addRegion" onsubmit="return validate();">
	<%=ScreenUtilities.screenHeader("region.title")%><table width="550" border="0" cellspacing="3" cellpadding="0">
			...
			<tr>
				<td  width="20%" class="tableTextBold" align=right nowrap>
					...
					<html:text size="12" property="regionName" styleClass="TextField" style="width:120 px" tabindex="1" maxlength="50" />
				</td>				
				...
				<td width="20%" align="left">
					<html:select property="aaiCategory" styleClass="TextField" style="width:150 px" tabindex="2">
			...
			<tr>
				<td  width="20%" class="tableTextBold" align=right nowrap>
					...
					<html:textarea  property="remarks" styleClass="TextField" style="width:120Px" tabindex="3" ></html:textarea>
				</td>				
			...
			<html:button  property="Clear" styleClass="butt" tabindex="5" onclick="clearData();"><bean:message key="button.clear" bundle="common"/> </html:button>
