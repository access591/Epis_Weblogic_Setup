...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="document.forms[0].unitCode.focus();" >
	
	<html:form action="/addUnit.do?method=addUnit" onsubmit="return validate();">
	...
	<table width="70%" border=0 align="center" >	
		<tbody >
			...
			<tr>
				<td  colspan=4 align=center>
				<html:submit   styleClass="butt" tabindex="5" > <bean:message key="button.save" bundle="common"/></html:submit>
				<html:button styleClass="butt" property="Clear" tabindex="6" onclick="clearData();">Clear </html:button>
				<html:button  property="Cancel" styleClass="butt" tabindex="7" onclick="javascript:window.location.href='searchUnit.do?method=searchUnit'" onblur="document.forms[0].unitCode.focus();" ><bean:message key="button.cancel" bundle="common"/></html:button>
				</td>	
			</tr>
			<tr>
				<td colspan=4 align=center>&nbsp;
