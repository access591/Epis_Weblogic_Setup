	...
	<html:form method="post" action="loadAdvance.do?method=loadAdvanceForm">
      ...
      <td colspan="2"><table width="100%" border="0" cellspacing="1" cellpadding="1">
		...
		<tr>
			...
			<td>:</td>
			<td class="reportdata"><bean:write name="Form2ReportBean" property="resignationreason" /></td>
			<td>&nbsp;</td>
		</tr>
		 ...
		 <tr>
           ...
           <tr>					
			...
			<logic:equal property="resignationreason"  name="Form2ReportBean" value="personal">
	   ...
	   <tr>
        <td colspan="4"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="71%" align="center"><strong>Declaration of non-employment</strong></td>
          </tr>                 
       ...
       <tr>
        <td colspan="4"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <td width="19%" rowspan="2">&nbsp;</td>
            <td width="71%">I declare that I have not been employed in any factory/establishment to 
            which the Act applies for a continuous period of not less then 2 months immediately preceding 
            the date of my application for final withdrawal of my Provident Fund money. </td>           
          </tr>                 
