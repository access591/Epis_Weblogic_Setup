 <!--
/*
  * File       : PFWSanctionOrderRevised.jsp
  * Date       : 24-May-2012
  * Author     : Radha P
  * Description: 
...
<script type="text/javascript"> 
		...
		var revTransID=document.forms[0].revAdvanceTransID.value;
 	// alert(revTransID);
		if(revTransID!=""){
		frmFlag = "Edit";
		}else{
		frmFlag = "New";
		 ...
		 url="<%=basePath%>loadApproval.do?method=updatePFWRevisedDetails&frm_name="+frmName+"&bankflag="+bankFlag+"&frmFlag="+frmFlag;
			//alert(url);
...
<html>
	...
	<body onload="loadBankDetails();loadDet();">
		...
		<html:form method="post" action="loadApproval.do?method=updatePFWRevisedDetails">
			<%=ScreenUtilities.screenHeader("PFW Revised Sanction Order Verfication")%>
