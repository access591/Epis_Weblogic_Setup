...
<html>
	...
	function frmPrsnlReset(){
			 hide('false');
			url="<%=basePathWoView%>loadNoteSheet.do?method=loadFinalSettlementArrear";
	   		    document.forms[0].action=url;
			    document.forms[0].method="post";
				document.forms[0].submit();
	} 		
	function submitData(){
		...
		//	}			
			...
			if((document.forms[0].seperationreason.value=='Retirement') || (document.forms[0].seperationreason.value=='Termination') || (document.forms[0].seperationreason.value=='VRS') || (document.forms[0].seperationreason.value=='Death') || (document.forms[0].seperationreason.value=='Others') || (document.forms[0].seperationreason.value=='Resignation')){
				bool=true;
			}
			...
			if((document.forms[0].arreartype.value=='revisedinterestrate')|| (document.forms[0].arreartype.value=='dearnesspay')){
				var url ="<%=basePathWoView%>loadNoteSheet.do?method=saveFinalSettlementArrear&frm_station="+station+"&frm_sepReason="+seperationreason+"&frm_pensionno="+pensionNo+"&frm_fromyear="+fromYear+"&frm_toyear="+toYear+"&frm_region="+region+"&frm_name="+frmName;
...
%>
		...
		<%=ScreenUtilities.screenHeader("loansadvances.finalsettlementarrearnew.screentitle")%>
		<table width="750" border="0" cellspacing="3" cellpadding="0">
		
							<tr>
								<td class="screenlabelerrors" colspan="5" align="center" style="color:red">
								...
								<%} }%>	
										...
										<tr>
											...
											<td>												
												<html:select property="arreartype" styleClass="TextField" style="width:119px" tabindex="11" onchange="dispArrearDet()">
										...
										<tr id="payscaledet" style="display:none">
											...
											<td>
												<html:text property="arreardate" styleClass="TextField" maxlength="12" tabindex="12" readonly="readonly" />
										...
										<tr>
											...
											<select name="fromfinyear" class="TextField" style="width:119px" tabindex="11" >
											...
											<select name="tofinyear" class="TextField" style="width:119px" tabindex="11" >
												<option value=''>Select One</option>
												<%for (int j = 0; j < yearList.size(); j++) {%>
												<option value='<%=yearList.get(j)%>'>
													<%=yearList.get(j)%>
										...
										<tr>
											...
											<td>
												<html:text property="interestratefrom" styleClass="TextField" maxlength="12" tabindex="12" />
											...
											<td>
												<html:text property="interestrateto" styleClass="TextField" maxlength="12" tabindex="12" />
										...
										<tr  id="dearnesspay" style="display:none">
											...
											<select name="dpfromfinyear" class="TextField" style="width:119px" tabindex="11" >
												<option value=''>Select One</option>
												<%for (int j = 0; j < yearList.size(); j++) {%>
												<option value='<%=yearList.get(j)%>'>
													<%=yearList.get(j)%>
											...
											<select name="dptofinyear" class="TextField" style="width:119px" tabindex="11" >
												<option value=''>Select One</option>
												<%for (int j = 0; j < yearList.size(); j++) {%>
												<option value='<%=yearList.get(j)%>'>
													<%=yearList.get(j)%>
										...
										<tr>
											...
											<td>
												<html:select styleClass="TextField" property="paymentinfo" onchange="selectBankDetail();">
														<html:option value="">
															Select One
														</html:option>
														<html:option value="Y">
											...
											<td colspan="4">
												<table align="center" border="0" cellpadding="1" cellspacing="1" width="100%">
													...
													<tr>
														...
														<td>
															<html:text styleClass="TextField" property="bankemprtgsneftcode" maxlength="50"/>
														</td>
														<td>&nbsp;</td>
													</tr>
