<!--
/*
  * File       : NoteSheetReportOldFormat.jsp
  * Date       : 03/05/2011
  * Author     : Radha P
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="1">
          ...
          <tr>
            ...
            <td height="24" colspan="3" class="reportContent"><p STYLE="text-indent: 1cm">CPF interest rate for financial year
             <strong><bean:write name="reportBean" property="transMnthYear"/></strong> has been calculated provisionally @ <bean:write name="reportBean" property="rateOfInterest"/>% 
          ...
          <tr>
            ...
            <strong><bean:write name="reportBean" property="paymentdate"/>.</strong></p>
            </logic:notEqual>
