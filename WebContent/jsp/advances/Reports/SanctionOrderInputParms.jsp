...
function popupWindow(mylink, windowname)
 ...
 function LoadWindow(params){
	...
	function resetReportParams(){
		document.forms[0].action="<%=basePath%>advanceparamreport.do?method=loadAdvanceInputForm&flag=SanctionOrder";
      ...
      //    return false;
       //  }
		...
		if(document.forms[0].formType.value==''){
			...
			url="<%=basePath%>advanceparamreport.do?method=consSanctionOrder&frm_region="+regionID+"&frm_fromDate="+fromDate+"&frm_toDate="+toDate+"&frm_sepreason="+seperationreason+"&frm_trust="+trust+"&frm_reportType="+reportType+"&frm_station="+station;
...
function loadDetails(){
	...
	<body class="BodyBackground" onload="javascript:frmload();loadDetails();">
		...
		<form action="post">
			<%=ScreenUtilities.screenHeader("Consolidate Sanction Order Report Params")%>
