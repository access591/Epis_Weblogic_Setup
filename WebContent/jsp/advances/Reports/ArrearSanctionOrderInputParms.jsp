...
<%String path = request.getContextPath();
	...
	String forms[] = {"SANCTION ORDER-REGION WISE"};
...
function popupWindow(mylink, windowname)
 ...
 function LoadWindow(params){
	...
	function resetReportParams(){
		document.forms[0].action="<%=basePath%>advanceparamreport.do?method=loadAdvanceInputForm&flag=ArrearSanctionOrder";
       ...
       //  }
        ...
        /* var index=document.forms[0].select_region.selectedIndex;
      	 if(document.forms[0].select_region.selectedIndex<1) {
   		  ...
   		  var index=document.forms[0].seperationreason.selectedIndex;
      	 if(document.forms[0].seperationreason.selectedIndex<1) {
   		  alert("Please Select Reason For Seperation");
		...
		if(document.forms[0].formType.value==''){
		    ...
		    var airportcode="",seperationreason="";
			...
			if(document.forms[0].seperationreason.options[document.forms[0].seperationreason.selectedIndex].text=='Voluantry Retirement')
			{
			seperationreason=document.forms[0].seperationreason.options[document.forms[0].seperationreason.selectedIndex].value;
			}else{
			...
			url="<%=basePath%>advanceparamreport.do?method=consSanctionOrder&frm_region="+regionID+"&frm_fromDate="+fromDate+"&frm_toDate="+toDate+"&frm_sepreason="+seperationreason+"&frm_trust="+trust+"&frm_reportType="+reportType+"&frm_station="+station+"&frm_name="+frmName;
		//alert("url "+url);	
			
		
		   if(document.forms[0].formType.value=='SANSACTION ORDER-REGION WISE'){
...
function loadDetails(){
	...
	<body class="BodyBackground" onload="javascript:frmload();loadDetails();">
		...
		<form action="post">
			<%=ScreenUtilities.screenHeader("Final Settlement Arrear Sanction Order Report Params")%>
			<table width="100%" border="0" align="center" cellpadding="1" cellspacing="1">
				...
				<tr>
					...
					<td class="tableTextBold" align="right">
						Reason For Seperation&nbsp;<font color=red>*</font>
					</td>
					<td align="center">
						:
					</td>
				...
				<tr>
					...
					<td>
						<Select name='formType' class="TextField">
							<!-- <option value=''>
																				[Select One]
																			</option>-->
