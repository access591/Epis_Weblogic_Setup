...
function popupWindow(mylink, windowname)
 ...
 function LoadWindow(params){
	...
	function resetReportParams(){
		document.forms[0].action="<%=basePath%>advanceparamreport.do?method=loadAdvanceInputForm&flag=summarizedadvanceReportParam";
       ...
       //  }
        ...
        /* var index=document.forms[0].select_region.selectedIndex;
      	 if(document.forms[0].select_region.selectedIndex<1) {
			...
			url="<%=basePath%>advanceparamreport.do?method=summarizedAdvancesReport&frm_region="+regionID+"&frm_fromDate="+fromDate+"&frm_toDate="+toDate+"&frm_advancetype="+advancetype+"&frm_trust="+trust+"&frm_reportType="+reportType+"&frm_purposeType="+purposetype+"&frm_station="+station+"&advanceReportType=compltereport";
...
function loadDetails(){
	...
	<body class="BodyBackground" onload="javascript:frmload();loadDetails();">
		...
		<form action="post">
			<%=ScreenUtilities.screenHeader("Summarized Advances Report Params")%>
			<table width="100%" border="0" align="center" cellpadding="1" cellspacing="1">
				...
				<tr>
					...
					<td>
						<select name='select_advance_dtl' onchange="advance_info();" class="TextField" tabindex="4">
							...
							<option value='CPF' selected="selected">
								CPF Advance
							</option>
						</select>
					</td>
				...
				<tr>
					...
					<td id="pfwpurp" style="display:none;">
