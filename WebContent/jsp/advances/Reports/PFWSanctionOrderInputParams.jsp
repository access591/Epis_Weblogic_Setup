...
<html>
	<head>
		...
		function resetMaster(frmName){
		 	...
		 	document.forms[0].advanceTransID.value="";
		    document.forms[0].employeeName.value="";		  
		    document.forms[0].purposeType.value="";		    
		    document.forms[0].advanceTransyear.value=""; 
			var url="<%=basePath%>loadAdvanceForm4.do?method=loadPrintSanctionOrder&frm_name="+frmName;
		...
		function search(frmName)
		{
			...
			var url="<%=basePath%>loadAdvanceForm4.do?method=searchPrintPFWSanctionOrder&frm_name="+frmName;
			alert("url===="+url);
		 	document.forms[0].action=url;
			document.forms[0].method="post";
			document.forms[0].submit();
	...
	<body onload="document.forms[0].advanceTransID.focus();">
		<html:form method="post" action="/loadAdvanceForm4.do?method=loadPrintSanctionOrder">
		  		<%=ScreenUtilities.saearchHeader("loansadvances.pfwreportsearch.screentitle")%> 
				...
				<tr>
					<td width="37%" height="29" align="left" valign="top">
						<table width="155" border="0" cellspacing="1" cellpadding="1">
							<tr>  
								<td width="60">
									<input type="button" value="Print" class="btn" onclick="javascript:selectSubMenuOptions('Print-Sanc')">
								</td>
					...
					<tr>
						<td align="center" width="100%">
							<display:table cellspacing="0" cellpadding="0" class="GridBorder" style="width:100%;height:50px" export="true" sort="list" id="advanceList" sort="list" pagesize="10" name="requestScope.searchlist"
								requestURI="./loadAdvanceForm4.do?method=searchPrintPFWSanctionOrder">
