...
function popupWindow(mylink, windowname)
 ...
 function LoadWindow(params){
	...
	function resetReportParams(){
		document.forms[0].action="<%=basePath%>advanceparamreport.do?method=loadAdvanceInputForm&flag=CPFRejected";
       ...
       //  }
        ...
        /* var index=document.forms[0].select_region.selectedIndex;
      	 if(document.forms[0].select_region.selectedIndex<1) {
   		  ...
   		  if(document.forms[0].select_toyear.value==''){
		    ...
		    if(document.forms[0].select_toyear.value!=''){
		    	if (!convert_date(document.forms[0].select_toyear))
				{
					document.forms[0].select_toyear.focus();
					return false;
				}
			...
			monthID=document.forms[0].select_toyear.value;			
		    ...
		    var toDate=document.forms[0].select_toyear.value;
			...
			url="<%=basePath%>advanceparamreport.do?method=rejectedAdvancesReport&frm_region="+regionID+"&frm_fromDate="+fromDate+"&frm_toDate="+toDate+"&frm_advancetype="+advancetype+"&frm_trust="+trust+"&frm_reportType="+reportType+"&frm_purposeType="+purposetype+"&frm_station="+station+"&access_from="+aFrnm;
...
function loadDetails(){
	...
	<body class="BodyBackground" onload="javascript:frmload();loadDetails();">
		...
		<form action="post">
			<%=ScreenUtilities.screenHeader("Rejected Entries in Advances Input Params")%>
			<table width="100%" border="0" align="center" cellpadding="1" cellspacing="1">
				...
				<tr>
					...
					<td>
					<input type="text" name="select_year" class="TextField"  id="select_year"/>
						<a href="javascript:showCalendar('select_year');">
						<img src="<%=basePath%>images/calendar.gif" border="no" alt="Datepicker" /></a>
					</td>
				...
				<tr>
					...
					<td>
						<input type="text" name="select_toyear" class="TextField"  id="select_toyear"/>
						<a href="javascript:showCalendar('select_toyear');">
						<img src="<%=basePath%>images/calendar.gif" border="no" alt="Datepicker" /></a>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<select name='select_advance_dtl'  class="TextField" tabindex="4">
