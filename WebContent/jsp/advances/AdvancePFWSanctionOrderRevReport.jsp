										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												...
												<td width="58%" align="center">													 
													<strong>SANCTION ORDER<logic:notEqual  name="PFWSanctionOrderBean" property="pfwSanctionOrderNo" value="---"> - <bean:write name="PFWSanctionOrderBean" property="pfwSanctionOrderNo"/> </logic:notEqual>(Revised)</strong>
												</td>
												<td width="15%">
													&nbsp;
												</td>
