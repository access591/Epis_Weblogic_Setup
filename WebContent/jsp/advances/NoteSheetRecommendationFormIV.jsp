<!--
/*
  * File       : NoteSheetRecommendationFormIV.jsp
  * Date       : 15/04/2010
  * Author     : Suneetha V
  * Description: 
...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
	...
	function submitData(st,frmName){
		...
		//	}			
			...
			if(verifiedby=='PERSONNEL,FINANCE,SRMGRREC'){
			   flag="NewForm";
			}else{
				flag="EditForm";		
			}
...
document.forms[0].BankDetails.style.display = 'block'; 
}
}
var bankFlag='N';
...
<body class="bodybackground" onload="hide('<%=request.getAttribute("focusFlag")%>');getNominee();loadAdhoc();loadBankDetails();loadDetails('<%=request.getAttribute("nomineeInfo")%>','<bean:write name="advanceBean" property="frmName"/>')">
		<html:form method="post" action="editNoteSheet.do?method=updateNoteSheet">
				<%=ScreenUtilities.screenHeader("Final Settlement Verification Form")%>
		<table width="720" border="0" cellspacing="3" cellpadding="0">
										...
										<tr>
											...
											<td>
												<html:text property="emplshare" name="noteSheetInfo" styleClass="TextField" maxlength="15" tabindex="16" readonly="true"/>
											</td>
											<td class="tableTextBold">
												Employer Share ( Contribution)(B)<font color="red">&nbsp;*</font>:&nbsp;
											</td>
											<td>
												<html:text property="emplrshare" name="noteSheetInfo" styleClass="TextField" maxlength="15" tabindex="17" readonly="true"/>
											</td>
										</tr>
										<tr>
											<td class="tableTextBold">
											...
											<td>
												<html:text property="pensioncontribution" name="noteSheetInfo" styleClass="TextField" maxlength="15" tabindex="18" onblur="calNetContribution()" readonly="true"/>
											</td>
											...
											<td id="adhocamount" style="display:none;">
												<html:text property="adhocamt"  name="noteSheetInfo" styleClass="TextField" tabindex="19"  maxlength="13"  onblur="calNetContributionAmt()" readonly="true"/>
											</td>
										...
										<tr>
											...
											<html:text property="trust" name="noteSheetInfo" styleClass="TextField" tabindex="23" readonly="true" />
