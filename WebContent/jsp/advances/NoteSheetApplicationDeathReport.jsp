	...
	<html:form method="post" action="loadAdvance.do?method=loadAdvanceForm">
       ...
       <tr>
        <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="71%"><strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(to be verified by the personal department)</strong></td>
          </tr>                 
      ...
      <td colspan="2"><table width="100%" border="0" cellspacing="1" cellpadding="1">
		...
		<tr>
          ...
          <tr>
			<td>&nbsp;</td>
			<td  class="reportsublabel">Place of Death </td>
			<td>:</td>
			<td class="reportdata"><bean:write name="empNoteSheetPersonalInfoBean" property="emprelation" /></td>
			<td>&nbsp;</td>
		</tr> 	        
           ...
           <tr>
            <td>&nbsp;</td>
            <td class="reportsublabel" colspan="3">(Copy of Death certificate to be attached with the application)</td>
            <td>&nbsp;</td>
          </tr>               
          
          <tr>
			<td>&nbsp;</td>
			<td  class="reportsublabel">Name of Legal heir/Nominee </td>
			<td>:</td>
			<td class="reportdata"><bean:write name="empNoteSheetPersonalInfoBean" property="emprelation" /></td>
			<td>&nbsp;</td>
		</tr> 	 
		...
		<tr>
			<td>&nbsp;</td>
			<td  class="reportsublabel">Relation with Member  </td>
			<td>:</td>
			<td class="reportdata"><bean:write name="empNoteSheetPersonalInfoBean" property="emprelation" /></td>
			<td>&nbsp;</td>
		</tr> 
      ...
      <tr>      
        <td height="22" colspan="4" class="reportsublabel"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>            
            ...
            <td width="2%">&nbsp;</td>
            <td width="24%" class="reportsublabel">&nbsp;</td>
            <td width="30%" nowrap="nowrap" align="right">impression of the claimant</td>           
          </tr>	        
        </table></td>
      </tr> 
