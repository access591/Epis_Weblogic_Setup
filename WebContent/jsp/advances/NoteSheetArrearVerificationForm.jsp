<!--
/*
  * File       : NoteSheetArrearVerificationForm.jsp
  * Date       : 09/06/2010
  * Author     : Suneetha V
  * Description: 
...
<html>
	...
	if(!withDrawalDet()){
		...
		//	}			
			...
			if(verifiedby=='FINANCE,SRMGRREC'){
			   flag="NewForm";
			}else{
				flag="EditForm";		
			}
...
<body class="bodybackground" onload="hide('<%=request.getAttribute("focusFlag")%>');getNominee();loadAdhoc();loadBankDetails();dispArrDate();loadDetails('<%=request.getAttribute("nomineeInfo")%>','<bean:write name="advanceBean" property="frmName"/>')">
...
%>
     ...
     <%=ScreenUtilities.saearchHeader("Final Settlement Arrear Verification Form")%>
...
<logic:equal property="arreartype"  name="noteSheetInfo" value="dearnesspay">
									...
									<tr id="soremarks">
										...
										<tr id="transremarks">
											...
											<td colspan="3">
											   <table border="0">
											   <logic:notEqual  property="prevTransRemarks" name="noteSheetInfo" value="---">
											   <tr>
											   <td class="Data">
											<bean:write   property="prevTransRemarks" name="noteSheetInfo" /><img src="<%=basePath%>/images/spacer.gif" width="10" /> Sr. Manager (Finance)&nbsp;
											</td>
											</tr>
											</logic:notEqual>
											    <tr>
