...
<html>
	...
	<body>
        ...
        voluntary retiring/retired
         ...
         terminated
								...
								<table width="80%" border="1" bordercolor="black" align="center" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td class="reportContentlabel" align="center">
										 ...
										 <td class="reportContentlabel" align="center">
											Adjustment of Pension Contribution
											<br>
											Rs
										</td>
           ...
           Safdarjung Airport
											...
											<!--  added as per mail from seemant on 30-May-2011 -->
											<!--  added as per mail from anu jain on 10-Jun-2011 -->
											<logic:equal property="pensioncontribution" name="reportBean" value="0">
											<td align="right" class="reportContentdata">
												NIL
											</td>
											</logic:equal>
		...
		<!-- - Bank Deatils for Retirement & VRS & Resignation & Death Single Nominee Cases--->                
         <logic:notEqual name="reportBean" property="seperationreason" value="Termination">		
         ...
         <!-- - Common for Single & multiple nominee except Termination   cases --->
           <logic:notEqual name="reportBean" property="seperationreason" value="Termination">
        	  <logic:present name="bankMasterBean">	 
 			 <table width="80%" border="0" align="center" cellspacing="0" cellpadding="0">
				<tr>
				...
				<td  class="reportContentlabel">
					 <p STYLE="text-indent: 1cm;font-size: 20px;font-weight: bold;">
 				     <U>
 				      ...
 				      No payment to be released by region/station against this sanction order.
 				      </logic:notEqual>
 				      <logic:equal name="reportBean" property="seperationreason" value="VRS">
 				      No payment to be released by VRS/station against this sanction order.
 				      </logic:equal>
 				      </U>
 				     </p> 
 				</td>
         ...
         %>
									...
									<!--  added on 03-Dec-2011 for the case pf id  4888 -->
