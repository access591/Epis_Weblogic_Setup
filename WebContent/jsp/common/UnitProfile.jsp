...
<html>
  <head>
    ...
    <title>My JSP 'UnitProfile.jsp' starting page</title>    
				...
				<tr><td align=left>Level: Member </td><tr> -->
                  ...
                  <tr>
                    <td align="left" valign="top"><div class="glossymenu">
					 <a class="menuitem submenuheader" href="index.html">Upload Data </a>
                          <div class="submenu">
                            <ul>
                              <li><a href="<%=basePath%>jsp/profiles/unit/CPFRecoveriesUpload.jsp" target="leftbody">Monthly CPF Recoveries</a></li>
                              <li><a href="<%=basePath%>jsp/profiles/unit/CPFPaymentsUpload.jsp" target="leftbody">Monthly CPF Payments</a></li>
                              <li><a href="<%=basePath%>jsp/profiles/unit/SupplementaryDataUpload.jsp" target="leftbody">Suplementary Data</a></li>  
							  <li><a href="<%=basePath%>jsp/profiles/unit/OpeningBalanceEntry.jsp" target="leftbody">OB Entry</a></li>
                              <li><a href="<%=basePath%>jsp/profiles/unit/OpeningBalanceAdjustments.jsp" target="leftbody">OB Adjustments</a></li> 
							  <li><a href="<%=basePath%>jsp/profiles/unit/NewJoinessInfo.jsp" target="leftbody">Transfer In/Out cases, New Joined, Retired, Resigned & Death Cases</a></li>
							  <li><a href="<%=basePath%>jsp/profiles/unit/AdvanceRequestSearch.jsp" target="leftbody">Advances</a></li>
							  <li><a href="<%=basePath%>jsp/profiles/unit/PFWRequestSearch.jsp" target="leftbody">PFW</a></li>
							  <li><a href="<%=basePath%>jsp/profiles/unit/FinalSettlement.jsp" target="leftbody">Final Settlement</a></li>
                              <li style="border-bottom-color:#FFFFFF;" ><a href="<%=basePath%>jsp/profiles/unit/TransferOfPF.jsp" target="leftbody">Transfer of PF</a></li>
                            </ul>
                          </div>	
								 <a class="menuitem submenuheader" href="index.html">Reports </a>
                          <div class="submenu">
                            <ul>
                            <li><a href="<%=basePath%>jsp/profiles/unit/GeneratePFCard.jsp" target="leftbody">PF Card</a></li>
                              <li><a href="<%=basePath%>jsp/profiles/unit/GenerateForm2.jsp" target="leftbody">Form-2</a></li>
                              <li><a href="<%=basePath%>jsp/profiles/unit/GenerateForm9.jsp" target="leftbody">Form-9</a></li>
							    <li><a href="<%=basePath%>jsp/profiles/unit/GenerateForm10C.jsp" target="leftbody">Form-10C</a></li>
								<li><a href="<%=basePath%>jsp/profiles/unit/GenerateForm10D.jsp" target="leftbody">Form-10D</a></li>
