...
<html>
  <head>
    ...
    <title>My JSP 'RegionProfile.jsp' starting page</title>
                  ...
                  <tr>
                    <td align="left" valign="top"><div class="glossymenu">
					 <a class="menuitem submenuheader" href="index.html">Profile </a>
                          <div class="submenu">
                            <ul>
                            <li><a href="<%=basePath%>jsp/profiles/rhq/CPFRecoveriesUpload.jsp" target="leftbody">Monthly CPF Recoveries</a></li>
                              <li><a href="<%=basePath%>jsp/profiles/rhq/CPFPaymentsUpload.jsp" target="leftbody">Monthly CPF Payments</a></li>
                              <li><a href="<%=basePath%>jsp/profiles/rhq/SupplementaryDataUpload.jsp" target="leftbody">Suplementary Data</a></li>  
							  <li><a href="<%=basePath%>jsp/profiles/rhq/OpeningBalanceEntry.jsp" target="leftbody">OB Entry</a></li>
                              <li><a href="<%=basePath%>jsp/profiles/rhq/OpeningBalanceAdjustments.jsp" target="leftbody">OB Adjustments</a></li> 
							  <li><a href="<%=basePath%>jsp/profiles/rhq/NewJoinessInfo.jsp" target="leftbody">Transfer In/Out cases, New Joined, Retired, Resigned & Death Cases</a></li>
							  <li><a href="<%=basePath%>jsp/profiles/rhq/AdvanceRequestSearch.jsp" target="leftbody">Advances</a></li>
							  <li><a href="<%=basePath%>jsp/profiles/rhq/PFWRequestSearch.jsp" target="leftbody">PFW</a></li>
							  <li><a href="<%=basePath%>jsp/profiles/rhq/FinalSettlement.jsp" target="leftbody">Final Settlement</a></li>
                              <li  ><a href="<%=basePath%>jsp/profiles/rhq/TransferOfPF.jsp" target="leftbody">Transfer of PF</a></li>
                          ...
                          <div class="submenu">
                            <ul>
                            <li><a href="<%=basePath%>jsp/profiles/rhq/GeneratePFCard.jsp" target="leftbody">PF Card</a></li>
                              <li><a href="<%=basePath%>jsp/profiles/rhq/GenerateForm2.jsp" target="leftbody">Form-2</a></li>
                              <li><a href="<%=basePath%>jsp/profiles/rhq/GenerateForm9.jsp" target="leftbody">Form-9</a></li>
							    <li><a href="<%=basePath%>jsp/profiles/rhq/GenerateForm10C.jsp" target="leftbody">Form-10C</a></li>
								<li><a href="<%=basePath%>jsp/profiles/rhq/GenerateForm10D.jsp" target="leftbody">Form-10D</a></li>					  
