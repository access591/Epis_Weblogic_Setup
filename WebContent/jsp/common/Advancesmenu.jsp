                ...
                <td align="center" valign="top"><table width="180" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
					...
					<a class="menuitem submenuheader" href="index.html">Masters</a>
                          <div class="submenu">
                            <ul>
                              <li><a href="TrustType.html" target="leftbody">Advances </a></li>  
							   <li><a href="TrustType.html" target="leftbody">PFW Part -II Verification </a></li>  
							    <li><a href="TrustType.html" target="leftbody">PFW Part -III Verification  </a></li>  
                              <li style="border-bottom-color:#FFFFFF;" ><a href="InvestmentRatio.html" target="leftbody">Advance Verification</a></li>
                            </ul>
                          </div>
					  <a class="menuitem submenuheader" href="index.html">Approvals</a>
                          <div class="submenu">
                            <ul>
                              <li><a href="InitialProposal.html" target="leftbody">CPF Final Approval</a></li>
                              <li><a href="RequestForQuotation.html" target="leftbody">PFW Final Approval</a></li>                                                          
							  <li style="border-bottom-color:#FFFFFF;"><a href="InvestmentApproval.html" target="leftbody">Final Settlement</a></li>
                            </ul>
                          </div>
                      <a class="menuitem submenuheader" href="index.html">Reports</a>   
					  <div class="submenu">
                            <ul>
                              <li><a href="InitialProposal.html" target="leftbody">Final Payment Register</a></li>
                              <li><a href="InitialProposal.html" target="leftbody">Sanction Order-Regionwise</a></li>
							
							  <li style="border-bottom-color:#FFFFFF;"><a href="InvestmentApproval.html" target="leftbody">Advances Report</a></li>
                            </ul>
                          </div>
					  </div></td>
                  </tr>
