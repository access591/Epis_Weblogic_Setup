...
<html>
 ...
 function LoadWindow(params){
	...
	winHandle = window.open(newParams,"AAIEPF11","menubar=yes,toolbar = yes,scrollbars=yes,resizable=yes");
	winOpened = true;
	...
	function resetReportParams(){
		document.forms[0].action="<%=basePath%>aaiepfreportservlet.do?method=loadepf11";
	...
	function validateForm() {
		...
		url="<%=basePath%>aaiepfreportservlet.do?method=AAIEPF11Report"+params;
...
function getPFIDNavigationList()
	...
	<body class="BodyBackground" onload="javascript:frmload()">
		<%String monthID = "", yearDescr = "", region = "", monthNM = "";
            ...
            %>
		<form action="post">
			<%=ScreenUtilities.screenHeader(" AAI EPF-11 Input Params")%>
