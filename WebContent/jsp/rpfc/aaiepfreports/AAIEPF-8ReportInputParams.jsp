...
<html>
 ...
 function LoadWindow(params){
	...
	winHandle = window.open(newParams,"AAIEPF8","menubar=yes,toolbar = yes,scrollbars=yes,resizable=yes");
	winOpened = true;
	...
	function resetReportParams(){
		document.forms[0].action="<%=basePath%>aaiepfreportservlet.do?method=loadEPF-8";
	...
	function validateForm() {
		...
		url="<%=basePath%>aaiepfreportservlet.do?method=AAIEPF8Report"+params;
...
function getPFIDNavigationList()
	...
	<body class="BodyBackground" onload="javascript:frmload()">
		<%String monthID = "", yearDescr = "", region = "", monthNM = "";
            ...
            %>
		<form action="post">
				<%=ScreenUtilities.screenHeader("AAI EPF-8 Input Params")%>		
