...
<html>
 ...
 function LoadWindow(params){
	...
	function resetReportParams(){
		document.forms[0].action="<%=basePath%>aaiepfreportservlet.do?method=loadepf5";
	...
	function validateForm() {
		...
		url="<%=basePath%>aaiepfreportservlet.do?method=AAIEPF5Report"+params;
...
function getPFIDNavigationList()
	...
	<body class="BodyBackground" onload="javascript:frmload()">
		<%String monthID = "", yearDescr = "", region = "", monthNM = "";
            ...
            %>
		<form action="post">
		<%=ScreenUtilities.screenHeader("AAI EPF-5 Input Params")%>
