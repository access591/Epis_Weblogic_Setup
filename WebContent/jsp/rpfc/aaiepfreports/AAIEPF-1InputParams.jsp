...
<html>
 ...
 function LoadWindow(params){
	...
	function resetReportParams(){
		document.forms[0].action="<%=basePath%>aaiepfreportservlet.do?method=loadob";
	...
	function validateForm() {
		...
		url="<%=basePath%>aaiepfreportservlet.do?method=AAIEPF1Report"+params;
...
function getPFIDNavigationList()
	...
	<body class="BodyBackground" onload="javascript:frmload()">
		<%String monthID = "", yearDescr = "", region = "", monthNM = "";
            ...
            %>
		<form action="post">
		<%=ScreenUtilities.screenHeader("AAI EPF-1 Input Params")%>
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				%>
																...
																<tr>
																	...
																	<td>
																		<SELECT NAME="select_airport" class="TextField" style="width:120px">
