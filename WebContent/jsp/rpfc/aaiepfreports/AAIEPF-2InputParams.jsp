...
<html>
 ...
 function LoadWindow(params){
	...
	function resetReportParams(){
		document.forms[0].action="<%=basePath%>aaiepfreportservlet.do?method=loadepf2";
	...
	function validateForm() {
		...
		var yearValue=document.forms[0].select_year.options[document.forms[0].select_year.selectedIndex].text;

            
        if(yearValue=='Select One'){
		...
		url="<%=basePath%>aaiepfreportservlet.do?method=AAIEPF2Report"+params;
	...
	<body class="BodyBackground" onload="javascript:frmload()">
		<%String monthID = "", yearDescr = "", region = "", monthNM = "";
           ...
           if (request.getAttribute("year") != null) {
            ...
            %>
		<form action="post">
		<%=ScreenUtilities.screenHeader("AAI EPF-2 Input Params")%>
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td><Select name='select_formType' Style='width:100px' class="TextField">
						<option value='AAI EPF-1'>AAI EPF-2</option>
