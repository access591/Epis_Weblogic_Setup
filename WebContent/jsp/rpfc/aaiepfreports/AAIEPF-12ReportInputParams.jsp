...
<html>
 ...
 function LoadWindow(params){
	...
	winHandle = window.open(newParams,"AAIEPF12","menubar=yes,toolbar = yes,scrollbars=yes,resizable=yes");
	winOpened = true;
	...
	function resetReportParams(){
		document.forms[0].action="<%=basePath%>aaiepfreportservlet.do?method=loadepf12";
	...
	function validateForm() {
		...
		url="<%=basePath%>aaiepfreportservlet.do?method=AAIEPF12Report"+params;
...
function getPFIDNavigationList()
	...
	<body class="BodyBackground" onload="javascript:frmload()">
		<%String monthID = "", yearDescr = "", region = "", monthNM = "";
            ...
            %>
		<form action="post">
			<%=ScreenUtilities.screenHeader("AAI EPF-12 Input Params")%>
