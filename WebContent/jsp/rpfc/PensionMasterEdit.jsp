	...
	if(!answer){
	 document.forms[0].airPortCode.focus();
		...
		return false;
  	   ...
  	   if(document.forms[0].recordVerified.value==""){
  	    alert("Please Select Record Verified");
		document.forms[0].recordVerified.focus();
		return false;
  	   }
	  ...
	  {    
		...
		// alert("share is"+totalshare[l].value);
		  var finalShare=finalShare+parseInt(totalshare[l].value);
	   	...
	   	document.forms[0].action="<%=basePath%>search1?method=update&startIndex="+index+"&totalData="+totalData+"&airportWithRegion="+newAirportcodewithRegion;
...
function replaceAll(OldString, FindString, ReplaceString) {
 ...
 function getJsDate1(dateStr, objFlag)
	...
	<body class="BodyBackground" onload="document.forms[0].cpfacnoNew.focus(); hide();swap();retrimentDate();">

		<form method="post" action="<%=basePath%>search1?method=update">
            ...
            %>
                ...
                %>
									...
									<table align="center">
										<!--<%=bean1.getFamilyRow()%><%=bean1.getNomineeRow()%>
							...
							-->
										<tr>
											...
											<td>
												<input type="text" name="oldAirportCode" size="5" readonly="true" value='<%= bean1.getStation()%>'%>
												<select name="airPortCode" tabindex="2">
													<option value="">
														[Select One]
													</option>
													<%if (request.getAttribute("AirportList") != null) {
                        ...
                        %>
							...
							-->
										...
										<tr>
											...
											<td>
												<input type="text" name="employeeCode" maxlength="20" tabindex="3" value='<%=bean1.getEmpNumber()%>' onkeyup="return limitlength(this, 20)">
											</td>
											...
											<td>
												<input type="text" name="empName" maxlength="50" tabindex="4" onblur="getPensionNumber();" value='<%=bean1.getEmpName()%>' onkeyup="return limitlength(this,50)">
											</td>
										</tr>
										<tr>
											<td class="label">
											...
											<td>
												<input type="text" name="fhname" maxlength="50" tabindex="5" value='<%=bean1.getFhName()%>' onkeyup="return limitlength(this, 50)">
											</td>
                ...
                %>
										...
										<tr>
											...
											<td>
												...
												<select name="emplevel" tabindex="7" tabindex="9" onchange="getDesegnation(document.forms[0].emplevel.value)">
													<option value="">
														[Select One]
													</option>
											...
											<td>
												<input type="text" name="desegnation" readonly="true" tabindex="8" value='<%=bean1.getDesegnation()%>' onkeyup="return limitlength(this, 20)">
										...
										<tr>
											...
											<td>
												<input type="text" name="dateofbirth" tabindex="9" onblur="retrimentDate();getPensionNumber();" value='<%=bean1.getDateofBirth()%>' onkeyup="return limitlength(this, 20)">
											...
											<td>
												<input type="text" name="dateofjoining" tabindex="10" value='<%=bean1.getDateofJoining()%>' onkeyup="return limitlength(this, 20)">
                ...
                %>
												<select name="department" tabindex="20" style=display:inline;>
													<option value="">
														[Select One]
													</option>
                ...
                %>
												<select name="division" tabindex="21">
													<option value="">
														[Select One]
													</option>
										...
										<tr>
											...
											<td>
												<select name="reason" tabindex="11" id="mySelect" onChange="swap();" style=display:inline;>
                ...
                %>
											...
											<td>
												<input type="text" name="seperationDate" tabindex="12" value='<%=bean1.getDateofSeperationDate()%>' onkeyup="return limitlength(this, 20)">
										...
										<tr>
											...
											<td>
												<input type="text" name="Other" value='<%=bean1.getOtherReason()%>' id="myText" style="display:none;" tabindex="13" onclick="swapback()">
											</td>
										</tr>
										...
										<tr>
											...
											<td>
												<TEXTAREA name="paddress" size="150" maxlength="150" tabindex="14">
											...
											<td>
												<TEXTAREA name="taddress" size="150" maxlength="150" tabindex="15">
										...
										<tr>
											...
											<td>
												...
												<select name='wetherOption' tabindex="16">
                ...
                %>
											...
											<td>
												<select name="form1" tabindex="17" onchange="show()">
                ...
                %>
										...
										<tr>
											...
											<td>
												<input type="text" name="pensionNumber" maxlength="35" tabindex="18" readonly="true" value='<%=bean1.getPensionNumber()%>'>
											</td>
											...
											<td>
												<input type="text" name="dateOfAnnuation" readonly="true" tabindex="19" value='<%=bean1.getDateOfAnnuation()%>'>
											</td>
										</tr>
										...
										<tr>
											...
											<td>
												<input type="text" name="emailId" maxlength="50" onkeyup="return limitlength(this,50)" value='<%=bean1.getEmailId()%>' tabindex="23">
											</td>
											<td class="label">
												Record Verified: <font color="red">&nbsp;*</font>
											</td>
											<td>
												<%String recordVerified = bean1.getRecordVerified().trim();
                ...
                %>
												<select name="recordVerified" tabindex="8" style="width:130px">
													...
													<option value='N' <%if(recordVerified.equals("N")){ out.println("selected");}%>>
														No
													</option>
													<option value='Y' <%if(recordVerified.equals("Y")){ out.println("selected");}%>>
														Yes
													</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<TEXTAREA NAME="remarks" tabindex="22">
													<%=bean1.getRemarks()%>
												</TEXTAREA>
										...
										<tr>
											...
											<td>
												&nbsp;<b><img alt="Add New Record" src="<%=basePath%>PensionView/images/addIcon.gif" onclick="callFamily()" tabindex="27"></b>
											</td>
                    ...
                    %>
										<tr id="name1<%=i%>">
											<td>
												...
												<input type="text" name="FName" tabindex="24" maxlength="50" value='<%=fMemberName%>'>

												<input type="hidden" name="empOldFRName" value='<%=fMemberName%>'>
											</td>


											<td>
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<input type="text" name="Fdob" value='<%=fDateofBirth%>' tabindex="25">
												<a href="#" onclick="javascript:show_calendar('forms[0].Fdob'+<%=i%>);"><img src="<%=basePath%>PensionView/images/calendar.gif" border="no" /></a>
											</td>
											<td>

												<select name="Frelation" tabindex="26">
											...
											<td>
												&nbsp;<b><img alt="Delete" src="<%=basePath%>PensionView/images/cancelIcon.gif" onclick="deleteFamilyDetils('<%=bean1.getCpfAcNo()%>','<%=fMemberName%>','name1<%=i%>','<%=rowid%>');" tabindex="27"></b>
											</td>
										</tr>
									...
									<div id="divFamily1">
										<table>
											<tr>
												...
												<td>
													&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<input type="text" name="FName" maxlength="50" tabindex="27">
												</td>
												<input type="hidden" name="empOldFRName" value="">
												<td>
													&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<input type="text" name="Fdob" id="Fdob0" tabindex="28">
												...
												<td>
													&nbsp;
													<select name="Frelation" tabindex="29">
														<option value="">
															[Select One]
														</option>
														<option value='SPOUSE'>
									...
									<div id="divNomineeHead">
										<table align="center" width="95%">
											...
											<tr>
												...
												<td>
													&nbsp;<b><img alt="" src="<%=basePath%>PensionView/images/addIcon.gif" onclick="callNominee();dispOff()" tabindex="38"></b>
												</td>
                ...
                for (int i = 0; i < nomineeList.size(); i++) {
                    ...
                    %>
											<tr id="name<%=i%>">
												<td>
													<input type="text" size="18" name="Nname" maxlength="50" value='<%=nomineeName%>' onblur="dispOff()" tabindex="31">
													<input type="hidden" name="empOldNname" value='<%=nomineeName%>'>
												</td>
												<td>
													<input type="text" size="16" name="Naddress" maxlength="150" value='<%=nomineeAddress%>' tabindex="32">
												</td>
												<td>
													<input type="text" size="16" name="Ndob" value='<%=nomineeDob%>' tabindex="33">
													<a href="javascript:show_calendar('forms[0].Ndob');"><img src="<%=basePath%>PensionView/images/calendar.gif" border="no" /></a>
												</td>
												<td>

													<select name="Nrelation" tabindex="34">
														<option value="">
															[Select One]
														</option>
												...
												<td>
													<input type="text" size="16" name="guardianname" maxlength="50" value='<%=nameofGuardian%>' tabindex="35">
												</td>
												<td>
													<input type="text" size="16" name="gaddress" maxlength="150" value='<%=addressofGuardian%>' tabindex="36">
												</td>
												<td>
													<input type="text" size="5" name="totalshare" value='<%=totalShare%>' onkeypress="numsDotOnly()" tabindex="37">
												</td>
										...
										<div id="divNominee1">
											<table>
												<tr>
													<td>
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
														<input type="text" size="18" name="Nname" maxlength="50" tabindex="39" onblur="dispOff()">
															&nbsp; 
													...
													<td>
														&nbsp;
														<input type="text" size="16" name="Naddress" maxlength="150" tabindex="40">
													</td>
													<td>
														&nbsp;&nbsp;
														<input type="text" size="16" name="Ndob" tabindex="41">
														<a href="#" name="cal1" onclick="javascript:call_calender('forms[0].Ndob')"><img src="<%=basePath%>PensionView/images/calendar.gif" border="no" /></a>&nbsp;

													</td>
													<td>
														&nbsp;
														<select name="Nrelation" tabindex="40">
															<option value="">
																[Select One]
															</option>
															<option value='SPOUSE'>
													...
													<td>
														&nbsp;&nbsp;&nbsp;&nbsp;
														<input type="text" size="16" name="guardianname" maxlength="50" tabindex="42">

													</td>
													<td>
														&nbsp;&nbsp;
														<input type="text" size="16" name="gaddress" maxlength="150" tabindex="43">
															&nbsp; 
													</td>
													<td>
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
														<input type="text" size="5" name="totalshare" onkeypress="numsDotOnly()" tabindex="44">
													</td>
													<td>
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b></b>
													</td>
