...
<%@ page import="com.epis.bean.rpfc.EmployeePersonalInfo,com.epis.bean.rpfc.EmployeePensionCardInfo,com.epis.bean.rpfc.Form7MultipleYearBean"%>
...
<html>
	...
	<%
		...
		String region="",fileHead="",reportType="",fileName="",xlsPFID="";
		...
		if(request.getAttribute("xlsPurspose")!=null){
			xlsPFID=(String)request.getAttribute("xlsPurspose");
			if(region.equals("NO-SELECT")){
				fileHead=xlsPFID;
			}else{
			fileHead=fileHead+"_"+xlsPFID;
			}
		}
  ...
  <tr>
    ...
    <%
    	...
    	dueTotalEmoluments=Double.parseDouble(cardInfo.getEmoluments())+Double.parseDouble(cardInfo.getDueemoluments());
    	dueTotalPension=Math.round(Double.parseDouble(cardInfo.getPensionContribution()))+Double.parseDouble(cardInfo.getDuepensionamount());
    %>
      ...
      <tr>
        ...
        <td class="Data" width="30%" align="right"><%=Math.round(Double.parseDouble(cardInfo.getDueemoluments()))%></td>
        ...
        <td class="Data" width="23%" align="right"><%=Math.round(Double.parseDouble(cardInfo.getDuepensionamount()))%></td>
 ...
 <tr  bordercolor="white">
 <td colspan="8">Certified that the difference between the total of the contribution shown under col.(3) of the above table and that
