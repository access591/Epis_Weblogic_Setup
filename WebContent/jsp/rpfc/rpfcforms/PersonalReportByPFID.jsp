	...
	<body>
		<form action="method">
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				<%
					String spreason="",screenTitle="";
					if(request.getAttribute("seperationResaon")!=null){
						spreason=(String)request.getAttribute("seperationResaon");
						screenTitle="Employee Info-"+spreason;
					}else{
						spreason="";
						screenTitle="Employee Info";
					}
				%>
				<tr>
			...
			if (request.getAttribute("reportType") != null) {
				...
				if(request.getAttribute("form3RetrList")!=null){
					retireDataList=(ArrayList)request.getAttribute("form3RetrList");
				}
			...
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td class="HighlightData">
						Employee's who are reached Age 58 Years.But Seperation Reason is not updated.
					</td>
				</tr>
				<tr>
					<td>
