...
<html>
 ...
 function LoadWindow(params){
	...
	function resetReportParams(){
		document.forms[0].action="<%=basePath%>rpfcforms.do?method=loadtrustpcInput";
	...
	function validateForm() {
		...
		var transferFlag="",pfidStrip="",division="";	
		...
		if(monthID!='NO-SELECT' && yearID=='NO-SELECT'){
		...
		division=document.forms[0].select_trustType.options[document.forms[0].select_trustType.selectedIndex].value;
		...
		params = "&frm_region="+regionID+"&frm_year="+yearID+"&frm_reportType="+reportType+"&frm_empnm="+empName+"&frm_emp_flag="+frm_empflag+"&frm_pensionno="+empserialNO+"&frm_pfids="+pfidStrip+"&sortingOrder="+sortingOrder+"&frm_division="+division+"&frm_month="+monthID;
		url="<%=basePath%>rpfcforms.do?method=trustreport"+params;
...
String[] year=null;
            ...
            %>
		<form action="post">
				<%=ScreenUtilities.screenHeader("Trust Wise Pension Contribution Report Params")%>
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td><SELECT NAME="select_region" style="width:120px" onChange="javascript:getAirports('airport');" class="TextField">
				...
				<tr>
					...
					<td><SELECT NAME="select_airport" style="width:120px" class="TextField">
				...
				<tr>
					<td class=tableTextBold align="right" nowrap>Division:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					</td>
					<td><Select name='select_trustType' Style='width:130px'class="TextField" >
				...
				<tr>
					...
					<td><Select name='select_formType' Style='width:130px' class="TextField">
						<option value='PensionContr'>Trust Wise Pension Contribtion</option>
				...
				<tr>
					<td class=tableTextBold align="right" nowrap>Sorting Order: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td><SELECT NAME="select_sorting" style="width:88px" class="TextField">
							<option value="PENSIONNO">PFID</option>
							<option value="EMPLOYEENAME">EmployeeName</option>
							<option value="EMPLOYEENAME">DIVISION</option>
						 </SELECT>
					</td>
				</tr>
