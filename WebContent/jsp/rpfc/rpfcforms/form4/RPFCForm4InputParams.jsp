...
<html>
 ...
 function LoadWindow(params){
	...
	function resetReportParams(){
		document.forms[0].action="<%=basePath%>rpfcforms.do?method=loadrpfcform4";
	...
	function validateForm() {
		...
		url="<%=basePath%>rpfcforms.do?method=getrpfcform4"+params;
...
function getPFIDNavigationList()
	...
	<body class="BodyBackground" onload="javascript:frmload()">
		<%String monthID = "", yearDescr = "", region = "", monthNM = "";
            ...
            %>
		<form action="post">
<%=ScreenUtilities.screenHeader("Form-4 Input Params")%>
