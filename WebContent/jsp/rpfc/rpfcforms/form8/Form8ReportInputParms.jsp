...
<%String path = request.getContextPath();
		...
		String forms[] = {"FORM-8","FORM-8-PS","FORM-8-PS-Arrear"};
	%>
<html>
<HEAD>
...
function popupWindow(mylink, windowname)
		...
		progress=window.open(href, "form8", 'width=700,height=500,statusbar=yes,scrollbars=yes,resizable=yes');
 ...
 function LoadWindow(params){
	...
	function resetReportParams(){
		document.forms[0].action="<%=basePath%>rpfcforms.do?method=loadform8params";
	...
	function validateForm(user) {
		...
		if(document.forms[0].formType.value==''){
			...
			url = "<%=basePath%>rpfcforms.do?method=loadForm8&frm_region="+regionID+"&frm_year="+yearID+"&frm_month="+monthID+"&frm_reportType="+reportType+"&sortingOrder="+sortingOrder+"&frm_empnm="+empName+"&frm_emp_flag="+frm_empflag+"&frm_pensionno="+pensionno+"&frm_airportcd="+airportcode+"&frm_formType="+formType;
...
function getAirports(){	
	...
	var url ="<%=basePath%>psearch.do?method=getPersonalTblAirports&region="+regionID+"&frm_year="+yearID+"&frm_month="+monthID;;
...
%>
<form action="post">
		<%=ScreenUtilities.screenHeader("Form - 8 Report Params")%>
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				%>
															...
															<tr>
																	...
																	<td>
																		<input type="text"  name="txt_empname" class="TextField" readonly="readonly">
