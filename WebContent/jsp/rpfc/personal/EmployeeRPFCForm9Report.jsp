...
<%@ page import="com.epis.bean.rpfc.RPFCForm9Bean,com.epis.bean.rpfc.EmployeePersonalInfo,com.epis.bean.rpfc.NomineeBean" %>
<%
			...
			<table cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
					<td>
						<table cellpadding="0" cellspacing="0" width="100%">
						  <TR>
	   						 <td><span class="label">(1)	Shri</span> <span class="Data"> <%=form9Bean.getEmployeeName()%></span> is appointed as  <span class="Data"><%=form9Bean.getEmpDesig()%></span> in M/s …………………………..…………………………………………….(Name of the Factory/ Establishment ) with effect from <span class="Data"><%=form9Bean.getEmpDOJ()%></span> .</td>
   						 </TR>
   						 <TR>
