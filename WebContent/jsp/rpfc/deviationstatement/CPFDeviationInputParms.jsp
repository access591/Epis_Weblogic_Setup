...
<html>
 ...
 function LoadWindow(params){
	...
	function validateForm() {
		...
		url="<%=basePath%>validatefinance.do?method=deviationreport"+params;
...
function getPFIDNavigationList()
	...
	<body class="BodyBackground" onload="javascript:frmload()">
		<%String monthID = "", yearDescr = "", region = "", monthNM = "";
            ...
            %>
		<form action="post">
		<%=ScreenUtilities.screenHeader("CPF Deviation Statement Input Params")%>
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tbborder">
				...
				<tr>
					...
					<td>
						...
						<img src="<%=basePath%>/images/search1.gif" onclick="popupWindow('<%=basePath%>PensionView/PensionContributionMappedListWithoutTransfer.jsp','AAI');" alt="Click The Icon to Select EmployeeName" />
				...
				<tr>
					...
					<td><Select name='select_formType' Style='width:100px' class="TextField">
						<option value='CPF Deviation Statement'>CPF Deviation Statement</option>
