...
<html>
	...
	<table width="70%" border=0 align="center" ><form action="#" >
		<tbody >
			...
			<tr>
			<td  colspan=4 align=center><input type="button" value="Upload" onclick="javascript:window.location.href='<%=basePath%>jsp/profiles/chq/SupplementaryDataUpload.jsp?status=Y'" tabindex="4"><input type="button" value="Cancel" tabindex="5">
			<!-- 
