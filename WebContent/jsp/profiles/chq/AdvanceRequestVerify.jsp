...
<html>
	...
	<table width="100%" border=0 align="center" ><form action="#" >
		<tbody >
			...
			<tr>
			<td  colspan=4 align=center><input type="button" value="Submit" onclick="javascript:window.location.href='<%=basePath%>jsp/profiles/chq/AdvanceRequestSearch.jsp'" tabindex="4"><input type="button" value="Reset" tabindex="5">
