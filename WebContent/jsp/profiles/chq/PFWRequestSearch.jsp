...
<html>
	...
	<table width="85%" border=0 align="center">
		<tbody>
			...
			<tr>
			<td  colspan=4 align=center><input type="button" value="Search" onclick="javascript:window.location.href='<%=basePath%>jsp/profiles/chq/PFWRequestSearch.jsp'"><input type="button" value="Clear">
			<!-- 
			...
			<tr>
				<td colspan=4 align=left><input type="button" value="Approve" onclick="javascript:window.location.href='<%=basePath%>jsp/profiles/chq/PFWRequestVerify.jsp'"><input type="button" value="Delete">
				</td>
			</tr>
				<tr>
				<td colspan=4 align=center>
