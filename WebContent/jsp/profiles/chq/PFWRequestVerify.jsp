...
<html>
	...
	<table width="100%" border=0 align="center" ><form action="#">
		<tbody >
			...
			<tr>
			<td  colspan=4 align=center><input type="button" value="Next>>" onclick="javascript:window.location.href='<%=basePath%>jsp/profiles/chq/PFWRequestPart3Verify.jsp'" tabindex="4"><input type="button" value="Reset" tabindex="5">
