...
<html>
	...
	<table width="70%" border=0 align="center" ><form action="#" >
		<tbody >
			...
			<tr>
			<td  colspan=4 align=center><input type="button" value="OK" onclick="javascript:window.open('<%=basePath%>jsp/profiles/chq/PFCardReport.jsp')" tabindex="4"><input type="button" value="Reset" tabindex="5">
			<!-- 
