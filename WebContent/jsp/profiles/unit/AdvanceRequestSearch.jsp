...
<html>
	...
	<body><br><FIELDSET ><LEGEND class="epis">CPF Advance Requests Verification</LEGEND>
	<table width="85%" border=0 align="center">
		<tbody>
			...
			<tr>
			<td  colspan=4 align=center><input type="button" value="Search" onclick="javascript:window.location.href='<%=basePath%>jsp/profiles/unit/AdvanceRequestSearch.jsp'"><input type="button" value="Clear">
			<!-- 
			...
			<tr>
				<td colspan=4 align=left><input type="button" value="Verify" onclick="javascript:window.location.href='<%=basePath%>jsp/profiles/unit/AdvanceRequestVerify.jsp'"><input type="button" value="Delete">
				</td>
			</tr>
				<tr>
				<td colspan=4 align=center>
				<TABLE width=100% border=0 cellpadding=0 cellspacing=0  bordercolor="#d6dbe2" >
				<tr bgcolor="#d6dbe2"><td width=20 >&nbsp;</td><td width=100 class="epis" >PFID</td><td class="epis" width=150>Rquest Id</td><td width=150 class="epis">Request Date</td><td width=20>&nbsp;</td><td width=100 class="epis">Purpose</td><td class="epis" width=100>Amount</td><td width=200 class="epis">No. Of <br>Installments</td><td width=140 class="epis">Status</td><td width=100 class="epis"></td></tr>
				<tr bgcolor="#f4f4f4"><td width=20><input type=checkbox >  </td><td width=100 class="episdata" > 200752SC00012</td><td width=100 class="episdata">CPFREQ/HE/0109001</td><td width=100 class="episdata">01-Jan-2009</td><td>&nbsp;</td><td width=20 class="episdata">Higher Education</td><td width=20 class="episdata"> 25000</td><td width=20 class="episdata">12</td><td width=20 class="episdata">Verified</td><td width=20>&nbsp;</td></tr>
				<tr bgcolor="#e1e6e8"><td width=20><input type=checkbox >  </td><td width=100 class="episdata" > 200752SC00013</td><td width=100 class="episdata">CPFREQ/ME/0110012</td><td width=100 class="episdata">01-Jan-2010</td><td>&nbsp;</td><td width=20 class="episdata">Marriage Expenses</td><td width=20 class="episdata">120000</td><td width=20 class="episdata">24</td><td width=20 class="episdata">New Request</td><td width=20>&nbsp;</td></tr>
