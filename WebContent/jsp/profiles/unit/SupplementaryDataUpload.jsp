...
<html>
	...
	<body  ><br><FIELDSET ><LEGEND class="epis">Supplementary  Data Upload</LEGEND>
	<table width="70%" border=0 align="center" ><form action="#" >
		<tbody >
			<tr>
				<td colspan=4 align=center class="epis"><font color=blue><%="Y".equals(request.getParameter("status"))?"File SUPJan2010.xls Uploaded Successfuly":"&nbsp;"%></font>
				</td>
			</tr>
			<tr>
			...
			<tr>
			<td  colspan=4 align=center><input type="button" value="Upload" onclick="javascript:window.location.href='<%=basePath%>jsp/profiles/unit/SupplementaryDataUpload.jsp?status=Y'" tabindex="4"><input type="button" value="Cancel" tabindex="5">
			<!-- 
