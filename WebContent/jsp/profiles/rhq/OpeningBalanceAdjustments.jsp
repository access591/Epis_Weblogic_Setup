		...
		<FIELDSET>
			...
			<table width="70%" border=0 align="center">
				...
				<tbody>
					...
					<tr>
						<td colspan=4 align=center>
							<input type="button" value="Submit" onclick="javascript:window.location.href='<%=basePath%>jsp/profiles/rhq/OpeningBalanceAdjustments.jsp?status=Y'" tabindex="4">
