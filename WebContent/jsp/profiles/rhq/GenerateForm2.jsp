...
<html>
    ...
    <tr><td colspan=2>&nbsp;</td></tr>
    <tr><td colspan=2>&nbsp;</td></tr>
    <tr><td align="center" colspan=2><input type="button" value="Report" onclick="javascript:window.open('<%=basePath%>jsp/profiles/rhq/Form2Report.jsp')" ><input type="button" value="Cancel"/></td></tr>
   </table>
	</FIELDSET >
	</body>
</html>
