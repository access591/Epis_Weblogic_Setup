...
<html>
	...
	<body  ><br><FIELDSET ><LEGEND class="epis">Transfer In/Out cases, New Joinees, Retired, Resigned & Death cases</LEGEND>
	<table width="70%" border=0 align="center" ><form action="#" >
		<tbody >
			...
			<tr>
				<td colspan=4 align=center class="aims">Format Not Available.
				</td>
			</tr>
			<tr>
				<td colspan=4 align=center>&nbsp;
