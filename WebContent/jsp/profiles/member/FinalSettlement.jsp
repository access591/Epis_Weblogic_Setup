...
<html>
	...
	<table width="80%" border=0 align="center" ><form action="#" >
		<tbody >
			...
			<tr>
				<td colspan=4 align=left class="aims">When an Employee Resigned/Retired/Death Case, The Department will automatically do the final settlement. So clarification is required whether this option should be available in Member Profile or not.  
				</td>
			</tr>
			<tr>
				<td colspan=4 align=center>&nbsp;
