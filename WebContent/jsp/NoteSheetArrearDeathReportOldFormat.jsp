<!--
/*
  * File       : NoteSheetArrearDeathReportOldFormat.jsp
  * Date       : 28/07/2011
  * Author     : Radha P
          ...
          <tr>
           ...
           <bean:define id="nomineedet" name="Form2ReportBean" property="nomineename" />
								<tr>
									...
									<logic:notEqual name="Form2ReportBean" property="paymentdate" value="---">
            on or after <bean:write name="Form2ReportBean" property="paymentdate" />
										</p>
									</logic:notEqual>
       ...
       <logic:iterate id="trans" name="transList" indexId="slno">
		...
		<tr><td>&nbsp;</td></tr>
          ...
          <td>&nbsp;</td>
            ...
            <td width="15%">&nbsp;</td>
            <td width="30%"  class="reportContentlabel" >Sr. Mgr.(Finance)</td>
            <td width="5%">&nbsp;</td>
            <td width="30%" class="reportContentlabel" align="center">&nbsp;</td>
            <td width="10%">&nbsp;</td>
          </tr>
		...
		<tr><td>&nbsp;</td></tr>
         ...
         <tr>     
          ...
          <tr>     
            ...
            <td width="15%">&nbsp;</td>
            <td width="30%"  class="reportContentlabel" >DGM (F&A)</td>
            <td width="5%">&nbsp;</td>
            <td width="30%" class="reportContentlabel" align="center">&nbsp;</td>
            <td width="10%">&nbsp;</td>
          </tr>
		...
		<tr><td>&nbsp;</td></tr>
         ...
         <tr>     
          ...
          <tr>     
            ...
            <td width="15%">&nbsp;</td>
            <td width="30%"  class="reportContentlabel" >ED (F&A)</td>
            <td width="5%">&nbsp;</td>
            <td width="30%" class="reportContentlabel" align="center">&nbsp;</td>
            <td width="10%">&nbsp;</td>
          </tr>
