...
<%	
	if("excel".equals(StringUtility.checknull(reportType))){
		...
		response.setHeader("Content-Disposition", "attachment; filename=IncomeandExpenditure.xls");	
	}
%>
						...
						<table border="0" cellpadding="3" cellspacing="0" align="center" >
							...
							<tr>
								<td align="center" class="tblabel" colspan="5">
									...
									<bean:message key="ie.title" bundle="common" /> AS ON <%=CommonUtil.getFullNameofMonth(tomonth)%> 
								</td>
							</tr>
						</table>
					</td>
					...
					<td>
						<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="border">
							...
							<logic:iterate id="iereport" name="report" >
								<tr>
									<logic:iterate id="strieReport" name="iereport" >
									<td class="Data" align="right" nowrap="nowrap">
<logic:present name="strieReport">
										<bean:define  id="dispString"  name="strieReport" type="java.lang.String"/>
											<%=dispString%>		
</logic:present>	
									</td>									
									</logic:iterate>	
