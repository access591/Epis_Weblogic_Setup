...
<html>
	<head>
		...
		<script language="javascript" type="text/javascript">		  
			function  getReport(){
				...
				var url = "/reports.do?method=getScheduleReport&&trustType="+document.forms[0].trustType.value+"&&finYear="+document.forms[0].finYear.value+"&&toMonth="+document.forms[0].toMonth.value+"&&reportType="+document.forms[0].reportType.value+"&&scheduleType="+document.forms[0].scheduleType.value;
				window.open(url,"BalanceSheet","toolbar=yes,statusbar=yes,scrollbars=yes,menubar=yes,resizable=yes,width="+swidth+",height="+sheight+",top=0,left=0");
				return false;
			}
		</script>
	</head>
	...
	<body>
		<html:form action="/reports.do?method=getBalanceSheet" method="post"  onsubmit="return getReport()">
			<%=ScreenUtilities.screenHeader("sch.report.title")%>
			<table width="100%" border="0" align="center">
				...
				<tr>
					...
					<td width="20%">
						<html:select property="scheduleType" styleClass="TextField" style="width: 6cm">
						<html:options collection="schedule" property="schType" labelProperty="append" name="ScheduleTypeInfo" />
						</html:select>						
					</td>
				</tr>
				<tr>
