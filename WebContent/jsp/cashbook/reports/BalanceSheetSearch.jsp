...
<html>
	<head>
		...
		<script language="javascript" type="text/javascript">		  
			function  getReport(){
				...
				var url = "/reports.do?method=getBalanceSheet&&trustType="+document.forms[0].trustType.value+"&&finYear="+years+"&&toMonth="+document.forms[0].toMonth.value+"&&reportType="+document.forms[0].reportType.value;
	...
	<body>
		<html:form action="/reports.do?method=getBalanceSheet" method="post"  onsubmit="return getReport()">
			<%=ScreenUtilities.screenHeader("bs.title")%>
