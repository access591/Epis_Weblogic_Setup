						...
						<tr>
							<td>
								<table>
									...
									<tr>
										<td class="label">
											<%=info.getPartyType().equals("E")?"EMPLOYEE CPF NO":info.getPartyType().equals("B")?" BANK NAME":"PARTY NAME"%>
										</td>
										<td class="label">
											:
									...
									<tr>
										...
										<td class="label">
											<%=info.getPartyType().equals("I")|| info.getPartyType().equals("C")||info.getPartyType().equals("P")?"":": "+info.getPartyDetails().toUpperCase()%>
										</td>
									</tr>
									<tr>
										<td class="label">
											<%=info.getPartyType().equals("I")?"ISIN":""%>
										</td>
										<td class="label">
											<%=info.getPartyType().equals("I")?": "+info.getISIN(): ""%>
										</td>
									</tr>
<% 
