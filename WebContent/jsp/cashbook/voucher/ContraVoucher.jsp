...
<html>
			...
			function getBanksList(){
				if(xmlHttp.readyState ==4){		
					if(xmlHttp.status == 200){ 
						...
						document.forms[0].contraAccountNo.value = '<%=request.getParameter("contraAccountNo")==null?"":request.getParameter("contraAccountNo")%>';						
						getTrusttype('B');
						getTrusttype('C');
					}
				}
	...
	<body onload="yearSelect();">
		<form name="account" action="<%=basePathBuf%>Voucher?method=addContraRecord" onsubmit="javascript : return checkVoucher()" method="post">
		<input type="hidden" size="10" name="accHead" maxlength="50"  />
		
			<%=ScreenUtilities.screenHeader("Contra Voucher [Add]")%><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
								...
								<td height="15%">
									<table align="center" cellspacing="5" border="0">
										<tr>
											...
											<td class="tableTextBold" colspan=1 align="right">
												TO 
											</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td align="left">
												<input type="text" name="chequeNo" size="18"/>
											</td>
											<td width="10px">
											</td>
											<td class="tableTextBold" align="right" >												
											...
											<td align="left">
												<input type="text" name="amount"  size="18"/>
											</td>
										</tr>
										<tr>
											<td class="tableTextBold" align="right">
											...
											<td align="left">
												<input type="text" name="details" size="18"/>
											</td>
										</tr>
										<tr>
											<td class="tableTextBold" align="right" nowrap="nowrap">
											...
											<td align="left">
												<input type="text" name="prepDate"  size="13"/>
										...
										<tr>
											...
											<td colspan="4" align="left">
												<textarea cols="85" rows="3" name="voucherDetails"></textarea>
											</td>
										</tr>
										<tr>
											<td height="10px">
