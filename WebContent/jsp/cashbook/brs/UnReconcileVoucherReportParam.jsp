...
<html>
	<head>
		...
		<script language="javascript" type="text/javascript">		  
		   ...
		   if(!convert_date(document.forms[0].toDate)){
				...
				var url = "/unreconciledVoucherReport.do?method=unreconcileVoucherReport&&accountNo="+document.forms[0].accountNo.value+"&&reportType="+document.forms[0].reportType.value+"&&fromDate="+document.forms[0].fromDate.value+"&&toDate="+document.forms[0].toDate.value;
	...
	<body>
		<html:form action="/unreconciledVoucherReport.do?method=unreconcileVoucherReport" method="post" onsubmit="return getReport()">
			<%=ScreenUtilities.screenHeader("unreconciledvoucherreport.title")%>
