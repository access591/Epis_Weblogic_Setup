				...
				<tr>
					<td align="center">
						<table border="0" cellpadding="3" cellspacing="0" align="center" valign="middle">
							...
							<tr>
								<td align="center" class="tblabel" colspan="7">
									Transaction In Bank Statement Not in Company Book					
								</td>
							</tr>
						...
						<table width="80%" border="0" cellpadding="0" cellspacing="0" align="center" class="border">
							<tr>
								<td class="label" align="center" width="10%" nowrap>
									<bean:message key="brs.valuedt" bundle="common" />
								</td>
								<td class="label" align="center" width="30%" nowrap>
									<bean:message key="brs.description" bundle="common" />
								</td>								
							...
							<%
								double bankcreditAmt=0.0;
								double bankdebitAmt=0.0;
							%>
							...
							<tr>
								<td class="Data" align="left" width="10%">
									<bean:write name="brs"  property="valueDt"/>
								</td>
								<td class="Data" align="left" width="30%">
									<bean:write name="brs"  property="description"/>
								</td>
								
								<td class="Data" align="left" width="10%">
									<bean:write name="brs"  property="creditAmt"/>
									<bean:define id="bankcreditprice" name="brs" property="creditAmt" type="java.lang.String"/>
									<bean:define id="bankdebitprice" name="brs" property="debitAmt" type="java.lang.String"/>
								</td>
							...
							<%
								bankcreditAmt+=Double.parseDouble(bankcreditprice);
								bankdebitAmt+=Double.parseDouble(bankdebitprice);
							%>
							</logic:equal>							
							</logic:iterate>
							<%if(isFound==true){%>
							<tr>
								...
								<td class="Data" align="left"><%=cf.getDecimalCurrency(bankcreditAmt)%></td>
								<td class="Data" align="left"><%=cf.getDecimalCurrency(bankdebitAmt)%></td>
							</tr>
							<%}%>
							<%if(isFound==false){%>
							<tr>
					...
					<td>
						<table width="70%" border="0" cellpadding="0" cellspacing="0" align="center" class="border">
							...
							<%
								...
								double debitAmt=0.0;
							%>
							<logic:notEmpty  name="companyDatalist">
							<logic:iterate id="crs" name="companyDatalist">													
							<logic:equal name="crs" property="accountNo" value="<%=blist%>">						
								<% isFound=true;%>					
							<tr>
								<td class="Data" align="left" width="10%">
									<bean:write name="crs"  property="voucherDate"/>
								</td>
								<td class="Data" align="left" width="30%">
									<bean:write name="crs"  property="voucherNo"/>
								</td>
								
								<td class="Data" align="left" width="10%">
									<bean:write name="crs"  property="creditAmt"/>
									<bean:define id="creditprice" name="crs" property="creditAmt" type="java.lang.String"/>
									<bean:define id="debitprice" name="crs" property="debitAmt" type="java.lang.String"/>
								</td>
								<td class="Data" align="left" nowrap width="10%">
									<bean:write name="crs"  property="debitAmt"/>
								</td>	
							</tr>
							<%
